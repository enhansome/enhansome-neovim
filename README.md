...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 21,585 | 🐛 68 | 🌐 Lua | 📅 2026-06-29 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,957 | 🐛 36 | 🌐 Lua | 📅 2026-09-23 - Quickstart configurations for the LSP client.
...
* [hedyhli/outline.nvim](https://github.com/hedyhli/outline.nvim) ⭐ 1,040 | 🐛 37 | 🌐 Lua | 📅 2026-05-29 - A significantly enhanced and refactored fork of `symbols-outline.nvim`.
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 1,031 | 🐛 11 | 🌐 Lua | 📅 2026-09-23 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,844 | 🐛 79 | 🌐 JavaScript | 📅 2026-09-23 catalog.
...
* [retran/meow.yarn.nvim](https://github.com/retran/meow.yarn.nvim) ⭐ 82 | 🐛 2 | 🌐 Lua | 📅 2026-09-12 - Interactive LSP type and call hierarchy explorer with a tree view, live preview, navigation breadcrumbs, and a custom node renderer.
...
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 3,126 | 🐛 21 | 🌐 Lua | 📅 2026-09-23 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,735 | 🐛 0 | 🌐 Lua | 📅 2026-07-05 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 611 | 🐛 21 | 🌐 Lua | 📅 2026-09-23 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [jinzhongjia/LspUI.nvim](https://github.com/jinzhongjia/LspUI.nvim) ⭐ 298 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - A modern and useful UI that wraps LSP operations.
...
* [carldaws/miser.nvim](https://github.com/carldaws/miser.nvim) ⭐ 20 | 🐛 1 | 🌐 Lua | 📅 2026-09-21 - Start LSP servers, run formatters on save, and launch tasks straight from the tools declared in a project's `mise.toml`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
...
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,591 | 🐛 104 | 🌐 Lua | 📅 2026-09-20 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 123 | 🐛 4 | 🌐 Lua | 📅 2026-09-23 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-07-16 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 49,446 | 🐛 40 | 🌐 C | 📅 2026-09-23.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,100 | 🐛 21 | 🌐 Lua | 📅 2026-09-23 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,682 | 🐛 73 | 🌐 Vim Script | 📅 2026-08-11.
* [ms-jpq/coq\_nvim](https://github.com/ms-jpq/coq_nvim) ⭐ 3,815 | 🐛 186 | 🌐 Lua | 📅 2026-09-22 - Fast as FUCK completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
...
* [coder/claudecode.nvim](https://github.com/coder/claudecode.nvim) ⭐ 3,072 | 🐛 94 | 🌐 Lua | 📅 2026-09-13 - Claude Code integration using the WebSocket-based MCP protocol, with selection and diagnostics context sharing plus inline diffs.
  * [hebercosfer/floating-claude.nvim](https://github.com/hebercosfer/floating-claude.nvim) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-09-03 - Floating terminal provider for [claudecode.nvim](https://github.com/coder/claudecode.nvim) ⭐ 3,072 | 🐛 94 | 🌐 Lua | 📅 2026-09-13 that collapses into a corner notification while Claude edits and returns once idle.

<!--lint enable double-link-->

* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,166 | 🐛 49 | 🌐 Lua | 📅 2026-09-23 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,872 | 🐛 15 | 🌐 Lua | 📅 2026-09-22 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,847 | 🐛 6 | 🌐 Lua | 📅 2026-09-22 - OpenCode AI assistant integration.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,406 | 🐛 15 | 🌐 Lua | 📅 2026-08-14 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 626 | 🐛 16 | 🌐 Lua | 📅 2026-08-23 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 466 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-22 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [teocns/neocursor.nvim](https://github.com/teocns/neocursor.nvim) ⭐ 73 | 🐛 0 | 🌐 Lua | 📅 2026-09-02 - Next-edit predictions, cursor jumps, and ghost text, all driven by an existing Cursor session instead of an API key.
...
* [zgs225/pi2.nvim](https://github.com/zgs225/pi2.nvim) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-23 - Frontend for the [pi](https://pi.dev) coding agent with in-editor chat, reviewed diffs, session-tree navigation, and extension prompts.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 9 | 🐛 4 | 🌐 Lua | 📅 2026-09-23 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 12,552 | 🐛 700 | 🌐 Python | 📅 2026-09-22 tool.
...
* [jaitd/fieldguide.nvim](https://github.com/jaitd/fieldguide.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-09-21 - Sidebar agent for your own config; will inform you if config still boots when changing it and provides answers from your installed plugins' docs, the versions on disk, and the live session.
...
* [nvim-flutter/flutter-tools.nvim](https://github.com/nvim-flutter/flutter-tools.nvim) ⭐ 1,420 | 🐛 32 | 🌐 Lua | 📅 2026-09-08 - Build Flutter and Dart applications using the native LSP.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 591 | 🐛 36 | 🌐 Lua | 📅 2026-09-22 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [atomicptr/defold.nvim](https://github.com/atomicptr/defold.nvim) ⭐ 38 | 🐛 7 | 🌐 Rust | 📅 2026-09-22 - Batteries-included development environment for the Defold game engine.
...
* [jgonmor16/hdlsnip.nvim](https://github.com/jgonmor16/hdlsnip.nvim) ⭐ 5 | 🐛 0 | 🌐 VHDL | 📅 2026-09-23 - Parameterised VHDL templates covering entities, FSMs, CDC, AXI4-Lite and testbenches, following the project's reset style and target vendor.
...
* [ag-libs/lathe.nvim](https://github.com/ag-libs/lathe.nvim) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-09-20 - Java language server for Maven — code intelligence, diagnostics, run/test/debug, no classpath setup.
...
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 5,096 | 🐛 13 | 🌐 Lua | 📅 2026-09-15 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,645 | 🐛 5 | 🌐 Lua | 📅 2026-09-17 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
* [toppair/peek.nvim](https://github.com/toppair/peek.nvim) ⭐ 875 | 🐛 39 | 🌐 TypeScript | 📅 2024-08-20 - Preview Markdown in a webview window.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
...
* [tomasky/bookmarks.nvim](https://github.com/tomasky/bookmarks.nvim) ⭐ 183 | 🐛 8 | 🌐 Lua | 📅 2026-09-23 - Bookmarks with global file storage, written in Lua.
* [EvWilson/spelunk.nvim](https://github.com/EvWilson/spelunk.nvim) ⭐ 151 | 🐛 0 | 🌐 Lua | 📅 2026-09-23 - Create and manage bookmarks as stacks with a friendly UI.
...
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 10,854 | 🐛 68 | 🌐 Rust | 📅 2026-09-21 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 8,096 | 🐛 145 | 🌐 Lua | 📅 2026-05-25 - A modern fuzzy-finder to navigate your editor.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,445 | 🐛 11 | 🌐 Lua | 📅 2026-09-20 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,968 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 372 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,661 | 🐛 147 | 🌐 Rust | 📅 2026-09-21, a smart directory picker that tracks your usage.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,650 | 🐛 102 | 🌐 Lua | 📅 2026-09-23 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,920 | 🐛 158 | 🌐 Lua | 📅 2026-06-02 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,607 | 🐛 174 | 🌐 Lua | 📅 2026-09-17 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,875 | 🐛 9 | 🌐 Lua | 📅 2026-09-23 - Integration with the Yazi terminal file manager.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,689 | 🐛 93 | 🌐 Python | 📅 2026-09-23 - File manager. Better than NERDTree.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 463 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,999 | 🐛 1 | 🌐 C | 📅 2026-09-21 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 183 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,410 | 🐛 897 | 🌐 Python | 📅 2026-09-09 integration.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 101 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 42,373 | 🐛 63 | 🌐 Rust | 📅 2026-09-21).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 89 | 🐛 3 | 🌐 Lua | 📅 2026-09-23 - Easily load project-local settings (like `.vscode/settings.json`) into native LSP settings.
...
* [j-morano/buffer\_manager.nvim](https://github.com/j-morano/buffer_manager.nvim) ⭐ 401 | 🐛 5 | 🌐 Lua | 📅 2026-02-04 - Add one or more buffers, reorder them, save them inside a file or just delete them very easily from a small floating window.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,131 | 🐛 5 | 🌐 Lua | 📅 2026-07-14 - A high-performance color highlighter which has no external dependencies.
...
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 4,229 | 🐛 6 | 🌐 Vim Script | 📅 2026-06-08 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,328 | 🐛 0 | 🌐 Lua | 📅 2026-09-03 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [uhs-robert/oasis.nvim](https://github.com/uhs-robert/oasis.nvim) ⭐ 157 | 🐛 2 | 🌐 CSS | 📅 2026-09-22 - ***`[TS][LSP][L/D][Lua]`*** Desert theme ported from Vim and made modern with 12 variants, a collection of dark themes for every color of the rainbow.
...
* [rezniqov/soviet.nvim](https://github.com/rezniqov/soviet.nvim) ⭐ 28 | 🐛 0 | 🌐 Lua | 📅 2026-09-17 - ***`[TS][LSP][L/D][Lua]`*** Warm colorschemes inspired by soviet visual culture.
...
* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,634 | 🐛 10 | 🌐 Lua | 📅 2026-08-09 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,399 | 🐛 91 | 🌐 Lua | 📅 2026-05-10 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
* [Aejkatappaja/cendre](https://github.com/Aejkatappaja/cendre) ⭐ 167 | 🐛 1 | 🌐 Lua | 📅 2026-09-13 - ***`[TS][LSP][Lua]`*** Dark colorscheme with every hue computed from a wood fire's emission spectrum, plus matching ports for terminals and tools.
...
* [Aejkatappaja/sora](https://github.com/Aejkatappaja/sora) ⭐ 73 | 🐛 0 | 🌐 Lua | 📅 2026-08-18 - ***`[TS][LSP][Lua]`*** Deep blue-black dark colorscheme with one ethereal cyan accent, with matching ports for many terminal apps and tools.
...
* [calind/selenized.nvim](https://github.com/calind/selenized.nvim) ⭐ 32 | 🐛 3 | 🌐 Lua | 📅 2025-08-06 - ***`[TS][LSP][L/D][Lua]`*** Lua port of [selenized](https://github.com/jan-warchol/selenized) ⭐ 942 | 🐛 58 | 🌐 Emacs Lisp | 📅 2025-09-28 with support for Tree-sitter, `nvim-cmp`, GitSigns, and more.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [nvim-mini/mini.nvim#mini.statuscolumn](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statuscolumn.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for statuscolumn. Fast and improved defaults, fully customizable content, automatic dimming inside inactive windows.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
* [RRethy/vim-illuminate](https://github.com/RRethy/vim-illuminate) ⭐ 2,467 | 🐛 9 | 🌐 Lua | 📅 2026-08-25 - Highlight the word under the cursor with built-in LSP support.
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
* [nvimdev/dashboard-nvim](https://github.com/nvimdev/dashboard-nvim) ⭐ 2,868 | 🐛 74 | 🌐 Lua | 📅 2026-04-17 - A minimalist dashboard, inspired by doom-emacs.
...
* [Amansingh-afk/milli.nvim](https://github.com/Amansingh-afk/milli.nvim) ⭐ 318 | 🐛 1 | 🌐 Lua | 📅 2026-07-06 - Animated ASCII splash screens with bundled animations and custom image or GIF support.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,721 | 🐛 16 | 🌐 Lua | 📅 2026-09-21 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,807 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [Mirsmog/real-icons.nvim](https://github.com/Mirsmog/real-icons.nvim) ⭐ 83 | 🐛 0 | 🌐 Lua | 📅 2026-09-14 - Renders PNG and SVG file icons in explorers, pickers, statuslines, and tablines through kitty's graphics protocol.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 2,084 | 🐛 67 | 🌐 Lua | 📅 2026-09-04 - Add image support through kitty's graphics protocol or ueberzugpp.
* [edluffy/hologram.nvim](https://github.com/edluffy/hologram.nvim) ⭐ 1,432 | 🐛 28 | 🌐 Lua | 📅 2023-11-15 - A cross platform terminal image viewer. Works on macOS and Linux.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,493 | 🐛 226 | 🌐 Lua | 📅 2026-08-14 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,880 | 🐛 149 | 🌐 Lua | 📅 2026-09-21 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 2,172 | 🐛 52 | 🌐 Lua | 📅 2026-09-21 - Plugin for Obsidian, written in Lua.
...
* [jakewvincent/mkdnflow.nvim](https://github.com/jakewvincent/mkdnflow.nvim) ⭐ 829 | 🐛 20 | 🌐 Lua | 📅 2026-07-03 - Fluent Markdown notebook navigation and management (create links, follow links, create and manage to-do lists, reference bib files, and more).
...
* [iwe-org/iwe.nvim](https://github.com/iwe-org/iwe.nvim) ⭐ 55 | 🐛 0 | 🌐 Lua | 📅 2026-08-16 - Integration with `IWE`, an LSP designed for Markdown-based knowledge management and note-taking workflows.
* [ymic9963/mdnotes.nvim](https://github.com/ymic9963/mdnotes.nvim) ⭐ 41 | 🐛 7 | 🌐 Lua | 📅 2026-09-23 - Simple, improved, and extensible Markdown note taking.
...
* [jbyuki/instant.nvim](https://github.com/jbyuki/instant.nvim) ⭐ 1,415 | 🐛 9 | 🌐 Lua | 📅 2022-12-31 - A collaborative editing plugin written in Lua with no dependencies.
...
* [zeybek/camouflage.nvim](https://github.com/zeybek/camouflage.nvim) ⭐ 61 | 🐛 0 | 🌐 Lua | 📅 2026-09-22 - Hide sensitive values in configuration files during screen sharing by visually masking secrets in `.env`, `.json`, `.yaml`, `.toml`, and `.properties` files.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 32 | 🐛 1 | 🌐 Lua | 📅 2026-08-30 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,851 | 🐛 78 | 🌐 Go | 📅 2026-09-16 inside the editor.
...
* [dpezto/chezmoi-template.nvim](https://github.com/dpezto/chezmoi-template.nvim) ⭐ 10 | 🐛 2 | 🌐 Lua | 📅 2026-09-23 - Edit chezmoi source files natively: target-language Tree-sitter injection, template-aware formatting, live preview, diagnostics and completion.
...
* [rifen/timescope](https://github.com/rifen/timescope) ⭐ 5 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23 - Inspect numeric durations in code and view human-readable equivalents as inline virtual text.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 40 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,983 | 🐛 59 | 🌐 Rust | 📅 2026-07-04, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
...
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 914 | 🐛 28 | 🌐 Lua | 📅 2026-09-23 - Open your kitty scrollback buffer. Ameowzing.
...
* [waiting-for-dev/ergoterm.nvim](https://github.com/waiting-for-dev/ergoterm.nvim) ⭐ 106 | 🐛 0 | 🌐 Lua | 📅 2026-06-17 - Seamless terminal workflow integration with smart picker-based terminal selection, flexible text sending and persistent configuration.
...
* [Senal-D-A-Gunaratna/hyprfade.nvim](https://github.com/Senal-D-A-Gunaratna/hyprfade.nvim) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-09-23 - When using Hyprland, fade the terminal window via `hyprctl`.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 997 | 🐛 10 | 🌐 Lua | 📅 2026-08-25 - A modern, minimalistic UI for nvim-dap.
...
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,230 | 🐛 40 | 🌐 Python | 📅 2026-07-03 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
...
* [wurli/jet.nvim](https://github.com/wurli/jet.nvim) ⭐ 31 | 🐛 1 | 🌐 Lua | 📅 2026-09-21 - A LSP-enabled, extensible Jupyter client that just works.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` with framework for writing extensive plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
...
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,122 | 🐛 23 | 🌐 Lua | 📅 2026-08-22 - UI Component Library.
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 223 | 🐛 3 | 🌐 Lua | 📅 2026-09-23 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 57 | 🐛 9 | 🌐 Lua | 📅 2026-09-23 - A GitHub action that publishes your plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-05-26 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 23,683 | 🐛 19 | 🌐 Go | 📅 2026-08-29 or compatible encryption tools for cryptographic safety.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for enhanced Git integration with current editor process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 7,116 | 🐛 34 | 🌐 Lua | 📅 2026-09-22 - Git integration: signs, hunk actions, blame, etc.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,632 | 🐛 204 | 🌐 Lua | 📅 2026-08-22 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,365 | 🐛 52 | 🌐 Lua | 📅 2026-09-20 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,570 | 🐛 72 | 🌐 Lua | 📅 2026-09-15 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 400 | 🐛 19 | 🌐 Lua | 📅 2026-09-23 - Review pull requests and manage other GitLab resources.
...
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 337 | 🐛 9 | 🌐 Lua | 📅 2026-09-21 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 303 | 🐛 1 | 🌐 Go | 📅 2026-09-11 - A TUI native Git mergetool with 3 panes.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 127 | 🐛 7 | 🌐 Lua | 📅 2026-08-12 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 32,313 | 🐛 447 | 🌐 Rust | 📅 2026-09-19, with enhanced navigational features.
...
* [AckslD/nvim-gfold.lua](https://github.com/AckslD/nvim-gfold.lua) ⭐ 32 | 🐛 0 | 🌐 Lua | 📅 2022-10-19 - Plugin using [gfold](https://github.com/nickgerace/gfold) ⭐ 401 | 🐛 8 | 🌐 Rust | 📅 2026-09-22 to switch repo and have statusline component.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,383 | 🐛 248 | 🌐 Lua | 📅 2026-08-28 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [kkew3/jieba.vim](https://github.com/kkew3/jieba.vim) ⭐ 64 | 🐛 4 | 🌐 Rust | 📅 2026-09-23 - Word motions and word text objects for Chinese.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,310 | 🐛 41 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [gbprod/yanky.nvim](https://github.com/gbprod/yanky.nvim) ⭐ 1,287 | 🐛 34 | 🌐 Lua | 📅 2026-09-21 - Improved Yank and Put functionalities.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 965 | 🐛 7 | 🌐 Lua | 📅 2026-09-22 - Center the currently focused buffer to the middle of your terminal.
...
* [nacro90/numb.nvim](https://github.com/nacro90/numb.nvim) ⭐ 871 | 🐛 2 | 🌐 Lua | 📅 2026-09-22 - Peek lines in a non-obtrusive way.
...
* [keaising/im-select.nvim](https://github.com/keaising/im-select.nvim) ⭐ 369 | 🐛 11 | 🌐 Lua | 📅 2026-03-18 - Switching and restoring input method automatically depending on the edit mode.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 190 | 🐛 1 | 🌐 Lua | 📅 2026-08-15 - Undo tree for visualizing and managing undo history.
...
* [Nagato-Yuzuru/bang.nvim](https://github.com/Nagato-Yuzuru/bang.nvim) ⭐ 9 | 🐛 6 | 🌐 Lua | 📅 2026-09-19 - `g!` operator that filters a motion, text object or Visual selection through a shell command, like `!` without the whole-line limit.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [celeste3z/celeste\_comment.nvim](https://github.com/celeste3z/celeste_comment.nvim) ⭐ 43 | 🐛 0 | 🌐 Lua | 📅 2026-09-23 - VSCode-style commenting plugin with support for line and block comments, and textobjects.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for session management (read, write, delete).
...
* [jedrzejboczar/possession.nvim](https://github.com/jedrzejboczar/possession.nvim) ⭐ 398 | 🐛 13 | 🌐 Lua | 📅 2025-10-21 - Flexible session management with arbitrary persistent data stored as JSON.
...
* [uhs-robert/sshfs.nvim](https://github.com/uhs-robert/sshfs.nvim) ⭐ 164 | 🐛 1 | 🌐 Lua | 📅 2026-09-22 - Mount remote systems via SSHFS with smart picker auto-detect (Telescope/Oil/Snacks/Neo-tree/fzf-lua/Yazi/Ranger etc.).
...
* [kiyoon/jupynium.nvim](https://github.com/kiyoon/jupynium.nvim) ⭐ 776 | 🐛 11 | 🌐 Python | 📅 2026-09-20 - Selenium-automated Jupyter Notebook with real-time synchronization.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 432 | 🐛 29 | 🌐 Lua | 📅 2026-09-13 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,196 | 🐛 66 | 🌐 Lua | 📅 2026-04-28 - Solve Leetcode problems.
...
* [m4xshen/hardtime.nvim](https://github.com/m4xshen/hardtime.nvim) ⭐ 3,849 | 🐛 15 | 🌐 Lua | 📅 2026-09-13 - Helping you establish good command workflow and habit.
...
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 267 | 🐛 20 | 🌐 Lua | 📅 2026-09-22 - A single workflow for GitHub, GitLab, Bitbucket, and Jira.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 103 | 🐛 49 | 🌐 Go | 📅 2026-09-23 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [yal212/pomodoro.nvim](https://github.com/yal212/pomodoro.nvim) ⭐ 8 | 🐛 0 | 🌐 Lua | 📅 2026-08-27 - Focus-first Pomodoro timer with automatic work, break cycles, session statistics, and a distraction-free focus mode.
...
* [joryeugene/dadbod-grip.nvim](https://github.com/joryeugene/dadbod-grip.nvim) ⭐ 173 | 🐛 2 | 🌐 Lua | 📅 2026-09-22 - Database editor with inline cell editing, staged mutations with live SQL preview, schema browser, DDL, AI SQL generation, FK navigation, and DuckDB/Parquet support.
...
* [SpaceVim/SpaceVim](https://spacevim.org) - A community-driven modular distribution, inspired by [spacemacs](https://github.com/syl20bnr/spacemacs) ⭐ 24,558 | 🐛 64 | 🌐 Emacs Lisp | 📅 2026-09-22.

<!--lint enable double-link -->

* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 31,502 | 🐛 18 | 🌐 Lua | 📅 2026-09-14 - A launch point for your personal configuration.
...
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 27,534 | 🐛 77 | 🌐 Lua | 📅 2026-09-08 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,142 | 🐛 13 | 🌐 Rust | 📅 2026-09-23 - A cross-platform, easy to use version manager.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 64 | 🐛 0 | 🌐 Nix | 📅 2026-09-22 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [nvim-mini/mini.nvim#mini.input](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-input.md) ⭐ 9,542 | 🐛 37 | 🌐 Lua | 📅 2026-09-22 - Module of `mini.nvim` for getting user input with fully customizable key and view handling. Can show as floating window, statusline/tabline/winbar, virtual line/text. Provides `vim.ui.input()` implementation.
