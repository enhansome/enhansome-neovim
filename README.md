...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 21,431 | 🐛 67 | 🌐 Lua | 📅 2026-06-29 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,890 | 🐛 37 | 🌐 Lua | 📅 2026-08-17 - Quickstart configurations for the LSP client.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 1,023 | 🐛 11 | 🌐 Lua | 📅 2026-08-17 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,821 | 🐛 197 | 🌐 JavaScript | 📅 2026-08-18 catalog.
...
* [gfanto/fzf-lsp.nvim](https://github.com/gfanto/fzf-lsp.nvim) ⭐ 240 | 🐛 15 | 🌐 Lua | 📅 2024-08-07 - Enable the power of FZF fuzzy search for the built-in LSP.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,439 | 🐛 275 | 🌐 Lua | 📅 2026-06-19 - Easily install and manage LSP servers, DAP servers, linters, and formatters.
...
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 3,079 | 🐛 20 | 🌐 Lua | 📅 2026-08-18 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 605 | 🐛 21 | 🌐 Lua | 📅 2026-08-18 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,521 | 🐛 98 | 🌐 Lua | 📅 2026-08-15 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 118 | 🐛 1 | 🌐 Lua | 📅 2026-08-18 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-07-16 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 48,699 | 🐛 27 | 🌐 C | 📅 2026-08-18.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,093 | 🐛 21 | 🌐 Lua | 📅 2026-08-08 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,680 | 🐛 63 | 🌐 Vim Script | 📅 2026-08-11.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,118 | 🐛 47 | 🌐 Lua | 📅 2026-08-17 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,810 | 🐛 13 | 🌐 Lua | 📅 2026-08-18 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,651 | 🐛 22 | 🌐 Lua | 📅 2026-08-03 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,372 | 🐛 12 | 🌐 Lua | 📅 2026-08-14 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 592 | 🐛 15 | 🌐 Lua | 📅 2026-08-10 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 9 | 🐛 4 | 🌐 Lua | 📅 2026-08-18 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 12,375 | 🐛 681 | 🌐 Python | 📅 2026-08-12 tool.
...
* [leblocks/hopcsharp.nvim](https://github.com/leblocks/hopcsharp.nvim) ⭐ 17 | 🐛 9 | 🌐 Lua | 📅 2026-08-16 - Provides LSP-less navigation and type-hierarchy information in C# repositories.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 2,146 | 🐛 5 | 🌐 Lua | 📅 2026-08-12 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,964 | 🐛 264 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,927 | 🐛 12 | 🌐 Lua | 📅 2026-08-11 - Improve viewing Markdown files directly.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 285 | 🐛 11 | 🌐 Lua | 📅 2026-08-14 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [kibi2/tirenvi.nvim](https://github.com/kibi2/tirenvi.nvim) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2026-08-18 - Edit Markdown and CSV tables with lossless round-trip.
...
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,811 | 🐛 124 | 🌐 Tree-sitter Query | 📅 2026-07-19 - Create your own textobjects using Tree-sitter queries.
* [romus204/tree-sitter-manager.nvim](https://github.com/romus204/tree-sitter-manager.nvim) ⭐ 871 | 🐛 17 | 🌐 Tree-sitter Query | 📅 2026-08-03 - A lightweight Tree-sitter parser manager for Neovim 0.12+.
...
* [chentoast/marks.nvim](https://github.com/chentoast/marks.nvim) ⭐ 1,184 | 🐛 56 | 🌐 Lua | 📅 2025-05-13 - A better user experience for viewing and interacting with Vim marks.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,998 | 🐛 0 | 🌐 Lua | 📅 2026-08-13 - Buffer-based live search and replace with full power of `rg` flags. Grug like.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,709 | 🐛 459 | 🌐 Lua | 📅 2026-08-17 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,709 | 🐛 459 | 🌐 Lua | 📅 2026-08-17 A highly extensible fuzzy finder over lists.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 10,066 | 🐛 70 | 🌐 Rust | 📅 2026-08-18 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,980 | 🐛 131 | 🌐 Lua | 📅 2026-05-25 - A modern fuzzy-finder to navigate your editor.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,423 | 🐛 10 | 🌐 Lua | 📅 2026-08-13 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,928 | 🐛 9 | 🌐 Rust | 📅 2026-08-17 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 370 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,701 | 🐛 138 | 🌐 Rust | 📅 2026-08-18, a smart directory picker that tracks your usage.
...
* [dtormoen/neural-open.nvim](https://github.com/dtormoen/neural-open.nvim) ⭐ 68 | 🐛 4 | 🌐 Lua | 📅 2026-06-24 - Intelligent `snacks.nvim` picker that teaches a neural network to rank files by what you're most likely to open next.
...
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,624 | 🐛 100 | 🌐 Lua | 📅 2026-08-12 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,832 | 🐛 148 | 🌐 Lua | 📅 2026-06-02 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,571 | 🐛 171 | 🌐 Lua | 📅 2026-08-18 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,847 | 🐛 11 | 🌐 Lua | 📅 2026-08-18 - Integration with the Yazi terminal file manager.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,690 | 🐛 93 | 🌐 Python | 📅 2026-08-18 - File manager. Better than NERDTree.
* [kevinhwang91/rnvimr](https://github.com/kevinhwang91/rnvimr) ⭐ 845 | 🐛 10 | 🌐 Python | 📅 2026-01-11 - A simple yet amazing file explorer.
* [A7Lavinraj/fyler.nvim](https://github.com/A7Lavinraj/fyler.nvim) ⭐ 762 | 🐛 22 | 🌐 Lua | 📅 2026-08-09 - File manager which can edit file system like a buffer with tree view.
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 464 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,809 | 🐛 4 | 🌐 C | 📅 2026-08-17 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 183 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,353 | 🐛 897 | 🌐 Python | 📅 2026-08-15 integration.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 100 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 41,460 | 🐛 65 | 🌐 Rust | 📅 2026-08-17).
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 197 | 🐛 2 | 🌐 Lua | 📅 2026-08-17 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [sainnhe/edge](https://github.com/sainnhe/edge) ⭐ 1,039 | 🐛 2 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** Clean and Elegant Color Scheme inspired by Atom One and Material.
* [shaunsingh/nord.nvim](https://github.com/shaunsingh/nord.nvim) ⭐ 1,017 | 🐛 33 | 🌐 Lua | 📅 2024-06-25 - ***`[TS][Lua]`*** A colorscheme based off of the Nord Color Palette.
...
* [ThorstenRhau/token](https://github.com/ThorstenRhau/token) ⭐ 208 | 🐛 0 | 🌐 Emacs Lisp | 📅 2026-08-17 - ***`[TS][LSP][L/D][Lua]`*** Token has warm tones and careful contrast, with full Tree-sitter and LSP integration.
...
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,576 | 🐛 11 | 🌐 Lua | 📅 2026-08-09 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,342 | 🐛 90 | 🌐 Lua | 📅 2026-05-10 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,392 | 🐛 1 | 🌐 Lua | 📅 2026-08-15 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
...
* [Aejkatappaja/sora](https://github.com/Aejkatappaja/sora) ⭐ 67 | 🐛 0 | 🌐 Lua | 📅 2026-08-17 - ***`[TS][LSP][Lua]`*** Deep blue-black dark colorscheme with one ethereal cyan accent, with matching ports for many terminal apps and tools.
* [mitander/flume.nvim](https://github.com/mitander/flume.nvim) ⭐ 61 | 🐛 0 | 🌐 Lua | 📅 2026-08-16 - ***`[TS][LSP][L/D][Lua]`*** Four-palette color system with consistent semantic roles and matching generated themes for terminal and developer tools.
...
* [DrKJeff16/which-colorscheme.nvim](https://github.com/DrKJeff16/which-colorscheme.nvim) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-08-16 - Cycle between colorschemes using either custom or autogenerated `which-key.nvim` bindings.
...
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,403 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,386 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,713 | 🐛 16 | 🌐 Lua | 📅 2026-07-22 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,807 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [Mirsmog/real-icons.nvim](https://github.com/Mirsmog/real-icons.nvim) ⭐ 71 | 🐛 0 | 🌐 Lua | 📅 2026-08-04 - Renders PNG and SVG file icons in explorers, pickers, statuslines, and tablines through kitty's graphics protocol.
...
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 693 | 🐛 0 | 🌐 Lua | 📅 2026-08-16 - Highly extensible Rich Presence for Discord.
...
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 2,100 | 🐛 63 | 🌐 Lua | 📅 2026-08-14 - Plugin for Obsidian, written in Lua.
...
* [ymic9963/mdnotes.nvim](https://github.com/ymic9963/mdnotes.nvim) ⭐ 36 | 🐛 8 | 🌐 Lua | 📅 2026-08-16 - Simple, improved, and extensible Markdown note taking.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 32 | 🐛 3 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,786 | 🐛 78 | 🌐 Go | 📅 2026-08-13 inside the editor.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 675 | 🐛 17 | 🌐 Lua | 📅 2026-05-02 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 40 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,934 | 🐛 58 | 🌐 Rust | 📅 2026-07-04, for easy previewing of tabular data.
...
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,990 | 🐛 8 | 🌐 Lua | 📅 2026-04-15 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,109 | 🐛 101 | 🌐 Lua | 📅 2026-08-16 - An extensible framework for interacting with tests within your editor.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-05-26 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 23,251 | 🐛 33 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 7,049 | 🐛 39 | 🌐 Lua | 📅 2026-08-11 - Git integration: signs, hunk actions, blame, etc.
...
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,341 | 🐛 53 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
...
* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 397 | 🐛 15 | 🌐 Lua | 📅 2026-08-18 - Review pull requests and manage other GitLab resources.
...
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 298 | 🐛 6 | 🌐 Lua | 📅 2026-08-17 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 127 | 🐛 6 | 🌐 Lua | 📅 2026-08-12 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 31,789 | 🐛 427 | 🌐 Rust | 📅 2026-08-02, with enhanced navigational features.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,365 | 🐛 240 | 🌐 Lua | 📅 2026-07-30 - Work with GitHub issues and PRs.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 4,208 | 🐛 29 | 🌐 Lua | 📅 2026-07-10 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [Aaronik/Treewalker.nvim](https://github.com/aaronik/Treewalker.nvim) ⭐ 613 | 🐛 0 | 🌐 Lua | 📅 2026-08-17 - Move seamlessly around the abstract syntax tree.
...
* [celeste3z/celeste\_comment.nvim](https://github.com/celeste3z/celeste_comment.nvim) ⭐ 28 | 🐛 0 | 🌐 Lua | 📅 2026-08-15 - VSCode-style commenting plugin with support for line and block comments, and textobjects.
...
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,309 | 🐛 97 | 🌐 Lua | 📅 2026-08-11 - A lightweight formatting engine that plays nice with LSP.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 419 | 🐛 28 | 🌐 Lua | 📅 2026-08-16 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,144 | 🐛 64 | 🌐 Lua | 📅 2026-04-28 - Solve Leetcode problems.
...
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 216 | 🐛 10 | 🌐 Lua | 📅 2026-08-17 - A single workflow for GitHub, GitLab, Bitbucket, and Jira.
...
* [gisketch/triforce.nvim](https://github.com/gisketch/triforce.nvim) ⭐ 305 | 🐛 0 | 🌐 Lua | 📅 2026-08-17 - Gamified stat tracker with XP, levels, achievements, and activity heatmaps for your coding sessions with lualine integration.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 102 | 🐛 30 | 🌐 Go | 📅 2026-08-18 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [clang-engineer/dadbod-vertica.nvim](https://github.com/clang-engineer/dadbod-vertica.nvim) ⭐ 2 | 🐛 0 | 🌐 Vim Script | 📅 2026-07-06 - Vertica adapter for [vim-dadbod](https://github.com/tpope/vim-dadbod) ⭐ 4,432 | 🐛 58 | 🌐 Vim Script | 📅 2026-01-07 via the official `vsql` client, with schema-tree integration for `vim-dadbod-ui`.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 31,284 | 🐛 22 | 🌐 Lua | 📅 2026-08-07 - A launch point for your personal configuration.
...
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 27,195 | 🐛 77 | 🌐 Lua | 📅 2026-06-02 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [CosmicNvim/CosmicNvim](https://github.com/CosmicNvim/CosmicNvim) ⭐ 1,162 | 🐛 0 | 🌐 Lua | 📅 2026-08-10 - CosmicNvim is a lightweight and opinionated config for web development, specifically designed to provide a COSMIC programming experience.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,137 | 🐛 20 | 🌐 Rust | 📅 2026-08-16 - A cross-platform, easy to use version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 38 | 🐛 0 | 🌐 Go | 📅 2026-08-18 - Another version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-08-17 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
