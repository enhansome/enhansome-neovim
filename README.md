...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 21,572 | 🐛 67 | 🌐 Lua | 📅 2026-06-29 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [zuqini/zpack.nvim](https://github.com/zuqini/zpack.nvim) ⭐ 156 | 🐛 0 | 🌐 Lua | 📅 2026-08-20 - A thin layer on top of `vim.pack` to support lazy-loading and `lazy.nvim`'s declarative spec.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,958 | 🐛 37 | 🌐 Lua | 📅 2026-09-18 - Quickstart configurations for the LSP client.
...
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,787 | 🐛 45 | 🌐 Lua | 📅 2026-08-25 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
...
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,346 | 🐛 76 | 🌐 Lua | 📅 2026-06-02 - A code outline window for skimming and quick navigation.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 1,029 | 🐛 11 | 🌐 Lua | 📅 2026-09-19 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,841 | 🐛 81 | 🌐 JavaScript | 📅 2026-09-19 catalog.
...
* [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) ⭐ 334 | 🐛 10 | 🌐 Lua | 📅 2026-07-29 - Setup LSP with JSON or YAML files.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,483 | 🐛 277 | 🌐 Lua | 📅 2026-06-19 - Easily install and manage LSP servers, DAP servers, linters, and formatters.
...
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 3,123 | 🐛 21 | 🌐 Lua | 📅 2026-09-19 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
...
* [jmbuhr/otter.nvim](https://github.com/jmbuhr/otter.nvim) ⭐ 902 | 🐛 21 | 🌐 Lua | 📅 2026-09-08 - Provides LSP features and a nvim-cmp completion source for languages embedded in other documents.
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 611 | 🐛 20 | 🌐 Lua | 📅 2026-09-19 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
* [zeioth/garbage-day.nvim](https://github.com/Zeioth/garbage-day.nvim) ⭐ 529 | 🐛 4 | 🌐 Lua | 📅 2026-08-19 - Garbage collector that stops inactive LSP clients to free RAM.
...
* [jinzhongjia/LspUI.nvim](https://github.com/jinzhongjia/LspUI.nvim) ⭐ 297 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - A modern and useful UI that wraps LSP operations.
...
* [vxpm/ferris.nvim](https://github.com/vxpm/ferris.nvim) ⭐ 124 | 🐛 1 | 🌐 Lua | 📅 2025-08-04 - Interact with Rust-Analyzer's LSP extensions.
...
* [Senal-D-A-Gunaratna/swapson.nvim](https://github.com/Senal-D-A-Gunaratna/swapson.nvim) ⭐ 8 | 🐛 0 | 🌐 Lua | 📅 2026-09-19 - Monkeypatches `mason.nvim` to route `npm` and `pip` installs through `bun` and `uv`, speeding up LSP and tool installation.
...
* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,893 | 🐛 19 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,484 | 🐛 304 | 🌐 Lua | 📅 2026-07-09 - Completion engine written in Lua, successor of `nvim-compe`.
  ...
  * [hrsh7th/cmp-nvim-lsp-signature-help](https://github.com/hrsh7th/cmp-nvim-lsp-signature-help) ⭐ 680 | 🐛 30 | 🌐 Lua | 📅 2025-11-14 - `nvim-cmp` source for displaying function signatures from an LSP client.
...
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,580 | 🐛 99 | 🌐 Lua | 📅 2026-09-10 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 123 | 🐛 4 | 🌐 Lua | 📅 2026-09-18 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-07-16 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 49,345 | 🐛 52 | 🌐 C | 📅 2026-09-19.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,100 | 🐛 20 | 🌐 Lua | 📅 2026-09-19 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,684 | 🐛 72 | 🌐 Vim Script | 📅 2026-08-11.
* [ms-jpq/coq\_nvim](https://github.com/ms-jpq/coq_nvim) ⭐ 3,815 | 🐛 186 | 🌐 Lua | 📅 2026-09-19 - Fast as FUCK completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
...
* [coder/claudecode.nvim](https://github.com/coder/claudecode.nvim) ⭐ 3,069 | 🐛 94 | 🌐 Lua | 📅 2026-09-13 - Claude Code integration using the WebSocket-based MCP protocol, with selection and diagnostics context sharing plus inline diffs.
  * [hebercosfer/floating-claude.nvim](https://github.com/hebercosfer/floating-claude.nvim) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-09-03 - Floating terminal provider for [claudecode.nvim](https://github.com/coder/claudecode.nvim) ⭐ 3,069 | 🐛 94 | 🌐 Lua | 📅 2026-09-13 that collapses into a corner notification while Claude edits and returns once idle.

<!--lint enable double-link-->

* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,166 | 🐛 45 | 🌐 Lua | 📅 2026-09-19 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,863 | 🐛 15 | 🌐 Lua | 📅 2026-09-19 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,837 | 🐛 7 | 🌐 Lua | 📅 2026-09-18 - OpenCode AI assistant integration.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,404 | 🐛 15 | 🌐 Lua | 📅 2026-08-14 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [Davidyz/VectorCode](https://github.com/davidyz/vectorcode) ⭐ 875 | 🐛 19 | 🌐 Python | 📅 2026-02-23 - Supercharge your LLM experience with repository-level RAG.
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 622 | 🐛 16 | 🌐 Lua | 📅 2026-08-23 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 466 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-18 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 9 | 🐛 2 | 🌐 Lua | 📅 2026-09-15 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 9 | 🐛 4 | 🌐 Lua | 📅 2026-09-19 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 12,529 | 🐛 698 | 🌐 Python | 📅 2026-09-08 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,704 | 🐛 36 | 🌐 Lua | 📅 2026-09-12 - Everything you need for a painless Java experience.
* [nvim-flutter/flutter-tools.nvim](https://github.com/nvim-flutter/flutter-tools.nvim) ⭐ 1,416 | 🐛 31 | 🌐 Lua | 📅 2026-09-08 - Build Flutter and Dart applications using the native LSP.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 583 | 🐛 37 | 🌐 Lua | 📅 2026-09-14 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 99 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,929 | 🐛 293 | 🌐 PHP | 📅 2026-09-19.
...
* [artur-shaik/jc.nvim](https://github.com/artur-shaik/jc.nvim) ⭐ 60 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - Java productivity layer on top of an externally managed `jdtls`, including class creation, code generation, annotation by search, refactoring, a neotest test runner, and a task runner for `gradle` and `maven`.
...
* [jgonmor16/hdlsnip.nvim](https://github.com/jgonmor16/hdlsnip.nvim) ⭐ 3 | 🐛 0 | 🌐 VHDL | 📅 2026-09-14 - Parameterised VHDL templates covering entities, FSMs, CDC, AXI4-Lite and testbenches, following the project's reset style and target vendor.
...
* [yanskun/gotests.nvim](https://github.com/yanskun/gotests.nvim) ⭐ 29 | 🐛 1 | 🌐 Lua | 📅 2024-07-11 - Make Go tests easy with [gotests](https://github.com/cweill/gotests) ⭐ 5,332 | 🐛 39 | 🌐 Go | 📅 2025-10-30.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 2,170 | 🐛 9 | 🌐 Lua | 📅 2026-09-07 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,998 | 🐛 265 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 5,079 | 🐛 11 | 🌐 Lua | 📅 2026-09-15 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,642 | 🐛 4 | 🌐 Lua | 📅 2026-09-17 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
* [toppair/peek.nvim](https://github.com/toppair/peek.nvim) ⭐ 874 | 🐛 39 | 🌐 TypeScript | 📅 2024-08-20 - Preview Markdown in a webview window.
...
* [kdheepak/panvimdoc](https://github.com/kdheepak/panvimdoc) ⭐ 322 | 🐛 6 | 🌐 CSS | 📅 2026-09-17 - A pandoc to vimdoc GitHub action.
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 292 | 🐛 10 | 🌐 Lua | 📅 2026-09-15 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [the-mayankjha/fk\_markdown.nvim](https://github.com/the-mayankjha/fk_markdown.nvim) ⭐ 20 | 🐛 2 | 🌐 Lua | 📅 2026-08-30 - Markdown renderer with live browser preview, synchronized scrolling, and support for math, diagrams, LaTeX, and local images.
...
* [rogue-87/inlyne.nvim](https://github.com/rogue-87/inlyne.nvim) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2026-09-07 - Wrapper for [inlyne](https://github.com/Inlyne-Project/inlyne) ⭐ 1,346 | 🐛 67 | 🌐 Rust | 📅 2026-08-06 Markdown viewer.
...
* [potamides/pantran.nvim](https://github.com/potamides/pantran.nvim) ⭐ 333 | 🐛 11 | 🌐 Lua | 📅 2025-04-07 - Translate your text with an interactive translation window.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 14,404 | 🐛 270 | 🌐 Tree-sitter Query | 📅 2026-09-19 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,302 | 🐛 11 | 🌐 Lua | 📅 2026-06-08 - A plugin for adding/changing/deleting surrounding delimiter pairs.
...
* [romus204/tree-sitter-manager.nvim](https://github.com/romus204/tree-sitter-manager.nvim) ⭐ 878 | 🐛 18 | 🌐 Tree-sitter Query | 📅 2026-09-17 - A lightweight Tree-sitter parser manager for Neovim 0.12+.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 9,224 | 🐛 147 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
* [chentoast/marks.nvim](https://github.com/chentoast/marks.nvim) ⭐ 1,188 | 🐛 56 | 🌐 Lua | 📅 2025-05-13 - A better user experience for viewing and interacting with Vim marks.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 2,017 | 🐛 0 | 🌐 Lua | 📅 2026-08-13 - Buffer-based live search and replace with full power of `rg` flags. Grug like.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,791 | 🐛 464 | 🌐 Lua | 📅 2026-08-17 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,791 | 🐛 464 | 🌐 Lua | 📅 2026-08-17 A highly extensible fuzzy finder over lists.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 10,761 | 🐛 83 | 🌐 Rust | 📅 2026-09-19 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 8,082 | 🐛 144 | 🌐 Lua | 📅 2026-05-25 - A modern fuzzy-finder to navigate your editor.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,444 | 🐛 12 | 🌐 Lua | 📅 2026-09-16 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,967 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 371 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,576 | 🐛 146 | 🌐 Rust | 📅 2026-09-14, a smart directory picker that tracks your usage.
...
* [willyelm/pulse.nvim](https://github.com/willyelm/pulse.nvim) ⭐ 48 | 🐛 0 | 🌐 Lua | 📅 2026-09-19 - A single entrypoint for commands. Use prefixes to quickly access diagnostics, Git and more via pickers.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,647 | 🐛 102 | 🌐 Lua | 📅 2026-09-18 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,911 | 🐛 158 | 🌐 Lua | 📅 2026-06-02 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,601 | 🐛 173 | 🌐 Lua | 📅 2026-09-17 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,872 | 🐛 10 | 🌐 Lua | 📅 2026-09-19 - Integration with the Yazi terminal file manager.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,689 | 🐛 93 | 🌐 Python | 📅 2026-09-19 - File manager. Better than NERDTree.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 463 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,954 | 🐛 1 | 🌐 C | 📅 2026-09-19 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 183 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,405 | 🐛 896 | 🌐 Python | 📅 2026-09-09 integration.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 101 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 42,289 | 🐛 61 | 🌐 Rust | 📅 2026-09-19).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 200 | 🐛 2 | 🌐 Lua | 📅 2026-09-19 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 88 | 🐛 3 | 🌐 Lua | 📅 2026-09-19 - Easily load project-local settings (like `.vscode/settings.json`) into native LSP settings.
...
* [chrisgrieser/nvim-early-retirement](https://github.com/chrisgrieser/nvim-early-retirement) ⭐ 257 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - Send buffers into early retirement by automatically closing them after x minutes of inactivity.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [TaDaa/vimade](https://github.com/TaDaa/vimade) ⭐ 674 | 🐛 10 | 🌐 Lua | 📅 2026-07-16 - Dim, fade, tint, animate, and customize colors in your windows and buffers.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 8,200 | 🐛 21 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 4,225 | 🐛 6 | 🌐 Vim Script | 📅 2026-06-08 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,648 | 🐛 9 | 🌐 Vim Script | 📅 2026-04-15 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
* [projekt0n/github-nvim-theme](https://github.com/projekt0n/github-nvim-theme) ⭐ 2,474 | 🐛 29 | 🌐 Lua | 📅 2024-12-31 - ***`[TS][LSP][L/D][Lua]`*** A GitHub theme, kitty, alacritty written in Lua. Support built-in LSP and Tree-sitter.
...
* [nyoom-engineering/oxocarbon.nvim](https://github.com/nyoom-engineering/oxocarbon.nvim) ⭐ 1,642 | 🐛 21 | 🌐 Fennel | 📅 2026-09-07 - ***`[TS][LSP][L/D][Lua]`*** A dark and light theme written in Fennel, inspired by IBM Carbon.
* [dracula/vim](https://github.com/dracula/vim) ⭐ 1,395 | 🐛 8 | 🌐 Vim Script | 📅 2026-08-09 - ***`[TS][LSP]`*** Famous beautiful dark powered theme.
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,327 | 🐛 0 | 🌐 Lua | 📅 2026-09-03 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [sainnhe/edge](https://github.com/sainnhe/edge) ⭐ 1,045 | 🐛 2 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** Clean and Elegant Color Scheme inspired by Atom One and Material.
...
* [silentium-theme/silentium.nvim](https://github.com/silentium-theme/silentium.nvim) ⭐ 34 | 🐛 0 | 🌐 Lua | 📅 2026-09-03 - ***`[TS][Luа]`*** Pragmatic and monochrome theme with the goal to increase reading speed and reduce eye strain by highlighting only what is needed.
...
* [rezniqov/soviet.nvim](https://github.com/rezniqov/soviet.nvim) ⭐ 26 | 🐛 0 | 🌐 Lua | 📅 2026-09-17 - ***`[TS][LSP][L/D][Lua]`*** Warm colorschemes inspired by soviet visual culture.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 3,096 | 🐛 5 | 🌐 Lua | 📅 2026-05-15 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
...
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,397 | 🐛 91 | 🌐 Lua | 📅 2026-05-10 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 4,076 | 🐛 38 | 🌐 Lua | 📅 2026-07-04 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,609 | 🐛 28 | 🌐 Lua | 📅 2026-04-15 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,403 | 🐛 2 | 🌐 Lua | 📅 2026-08-19 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
...
* [ribru17/bamboo.nvim](https://github.com/ribru17/bamboo.nvim) ⭐ 493 | 🐛 5 | 🌐 Lua | 📅 2025-11-25 - ***`[TS][LSP][Lua]`*** A warm green theme.
...
* [Everblush/nvim](https://github.com/Everblush/nvim) ⭐ 306 | 🐛 4 | 🌐 Lua | 📅 2025-05-18 - ***`[TS][LSP][Lua]`*** A dark, vibrant and beautiful colorscheme written in Lua.
...
* [polirritmico/monokai-nightasty.nvim](https://github.com/polirritmico/monokai-nightasty.nvim) ⭐ 170 | 🐛 0 | 🌐 Lua | 📅 2026-07-16 - ***`[TS][LSP][L/D][Lua]`*** A dark/light theme based on the Monokai color palette written in Lua, support for LSP, Tree-sitter and lots of plugins.
...
* [qaptoR-nvim/chocolatier.nvim](https://github.com/qaptoR-nvim/chocolatier.nvim) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-17 - ***`[TS][LSP][Lua]`*** An espresso/kimbie inspired chocolatey theme adapted from ellisonleao/gruvbox.nvim theme as a code template.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [Senal-D-A-Gunaratna/matugen.nvim](https://github.com/Senal-D-A-Gunaratna/matugen.nvim) ⭐ 29 | 🐛 0 | 🌐 Lua | 📅 2026-09-19 - Material You colorscheme generator using an external template system. Supports Tree-sitter, LSP, and Lua.
...
* [nvim-mini/mini.nvim#mini.statuscolumn](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statuscolumn.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for statuscolumn. Fast and improved defaults, fully customizable content, automatic dimming inside inactive windows.
...
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,598 | 🐛 15 | 🌐 Lua | 📅 2026-05-31 - IDE-like breadcrumbs, out of the box.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 8,136 | 🐛 273 | 🌐 Lua | 📅 2026-05-31 - Easily configurable, blazingly fast statusline.
* [rebelot/heirline.nvim](https://github.com/rebelot/heirline.nvim) ⭐ 1,292 | 🐛 28 | 🌐 Lua | 📅 2025-05-23 - A no-nonsense statusline designed around recursive inheritance to be exceptionally fast and versatile.
...
* [tamton-aquib/staline.nvim](https://github.com/tamton-aquib/staline.nvim) ⭐ 400 | 🐛 8 | 🌐 Lua | 📅 2024-06-02 - A modern lightweight statusline in Lua. Mainly uses unicode symbols for showing info.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 211 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,966 | 🐛 37 | 🌐 Vim Script | 📅 2026-09-09 that aims to be as light and simple as possible.
...
* [konapun/vacuumline.nvim](https://github.com/konapun/vacuumline.nvim) ⭐ 31 | 🐛 1 | 🌐 Lua | 📅 2023-02-18 - A galaxyline configuration inspired by airline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,370 | 🐛 105 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,730 | 🐛 35 | 🌐 Lua | 📅 2026-06-10 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
...
* [willothy/nvim-cokeline](https://github.com/willothy/nvim-cokeline) ⭐ 636 | 🐛 14 | 🌐 Lua | 📅 2026-06-19 - A bufferline for people with addictive personalities.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [ya2s/nvim-cursorline](https://github.com/ya2s/nvim-cursorline) ⭐ 479 | 🐛 7 | 🌐 Lua | 📅 2026-02-14 - Highlights cursor words and lines.
* [mawkler/modicator.nvim](https://github.com/mawkler/modicator.nvim) ⭐ 379 | 🐛 3 | 🌐 Lua | 📅 2026-04-10 - Cursor line number mode indicator. Changes the `CursorLineNr` highlight based on Vim mode.
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,411 | 🐛 33 | 🌐 Lua | 📅 2026-08-25 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,385 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,717 | 🐛 16 | 🌐 Lua | 📅 2026-09-18 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,808 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 2,080 | 🐛 67 | 🌐 Lua | 📅 2026-09-04 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 709 | 🐛 0 | 🌐 Lua | 📅 2026-08-16 - Highly extensible Rich Presence for Discord.
...
* [neo451/feed.nvim](https://github.com/neo451/feed.nvim) ⭐ 207 | 🐛 12 | 🌐 Lua | 📅 2026-04-01 - Web feed reader written in Lua (RSS, Atom, JSON feed).
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,489 | 🐛 226 | 🌐 Lua | 📅 2026-08-14 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,880 | 🐛 150 | 🌐 Lua | 📅 2026-09-19 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 2,164 | 🐛 51 | 🌐 Lua | 📅 2026-09-18 - Plugin for Obsidian, written in Lua.
...
* [zk-org/zk-nvim](https://github.com/zk-org/zk-nvim) ⭐ 863 | 🐛 1 | 🌐 Lua | 📅 2026-09-12 -  Provides integration with `zk`, a plain text note-taking assistant.
* [jakewvincent/mkdnflow.nvim](https://github.com/jakewvincent/mkdnflow.nvim) ⭐ 828 | 🐛 20 | 🌐 Lua | 📅 2026-07-03 - Fluent Markdown notebook navigation and management (create links, follow links, create and manage to-do lists, reference bib files, and more).
...
* [ymic9963/mdnotes.nvim](https://github.com/ymic9963/mdnotes.nvim) ⭐ 38 | 🐛 7 | 🌐 Lua | 📅 2026-09-18 - Simple, improved, and extensible Markdown note taking.
...
* [code-biscuits/nvim-biscuits](https://github.com/code-biscuits/nvim-biscuits) ⭐ 347 | 🐛 6 | 🌐 Lua | 📅 2026-03-23 - A port of Assorted Biscuits. Ends up with more supported languages too.
...
* [zeybek/camouflage.nvim](https://github.com/zeybek/camouflage.nvim) ⭐ 61 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - Hide sensitive values in configuration files during screen sharing by visually masking secrets in `.env`, `.json`, `.yaml`, `.toml`, and `.properties` files.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 32 | 🐛 1 | 🌐 Lua | 📅 2026-08-30 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,848 | 🐛 78 | 🌐 Go | 📅 2026-09-16 inside the editor.
...
* [StefanBartl/color\_my\_ascii.nvim](https://github.com/StefanBartl/color_my_ascii.nvim) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-09-19 - Colorful highlighting of ASCII art in Markdown code blocks.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 40 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,973 | 🐛 59 | 🌐 Rust | 📅 2026-07-04, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 2,041 | 🐛 10 | 🌐 Lua | 📅 2026-09-19 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [RedEye-Developers/starfall.nvim](https://github.com/RedEye-Developers/starfall.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - Star twinkling, falling and shooting star crossing animation in background.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,605 | 🐛 92 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
* [kassio/neoterm](https://github.com/kassio/neoterm) ⭐ 1,338 | 🐛 31 | 🌐 Vim Script | 📅 2023-03-09 - Wrapper of some `:terminal` functions.
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 915 | 🐛 29 | 🌐 Lua | 📅 2026-08-13 - Open your kitty scrollback buffer. Ameowzing.
...
* [willothy/flatten.nvim](https://github.com/willothy/flatten.nvim) ⭐ 724 | 🐛 17 | 🌐 Lua | 📅 2026-06-19 - Open files from terminal buffers in your current editor instance instead of launching a nested instance.
...
* [samjwill/nvim-unception](https://github.com/samjwill/nvim-unception) ⭐ 244 | 🐛 9 | 🌐 Lua | 📅 2026-05-14 - Automatic unnesting of editor sessions started from terminal buffers.
* [chomosuke/term-edit.nvim](https://github.com/chomosuke/term-edit.nvim) ⭐ 215 | 🐛 8 | 🌐 Lua | 📅 2024-10-17 - Allowing you to edit your command in the terminal just like any other buffer.
...
* [ingur/floatty.nvim](https://github.com/ingur/floatty.nvim) ⭐ 31 | 🐛 0 | 🌐 Lua | 📅 2026-07-05 - A tiny (<200 LOC) but highly customizable floating terminal manager.
...
* [TheLazyCat00/runner-nvim](https://github.com/TheLazyCat00/runner-nvim) ⭐ 13 | 🐛 1 | 🌐 Lua | 📅 2026-02-11 - Run commands in a floating terminal and keep track of the last command executed per CWD, making it easy to repeat build or test commands.
...
* [Senal-D-A-Gunaratna/hyprfade.nvim](https://github.com/Senal-D-A-Gunaratna/hyprfade.nvim) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - When using Hyprland, fade the terminal window via `hyprctl`.
...
* [theHamsta/nvim-dap-virtual-text](https://github.com/theHamsta/nvim-dap-virtual-text) ⭐ 1,085 | 🐛 13 | 🌐 Lua | 📅 2025-05-25 - Virtual text support for nvim-dap.
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 996 | 🐛 10 | 🌐 Lua | 📅 2026-08-25 - A modern, minimalistic UI for nvim-dap.
...
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 1,030 | 🐛 19 | 🌐 Lua | 📅 2026-05-24 - Improved quickfix UI and editable quickfix buffer.
...
* [mr-u0b0dy/crazy-coverage.nvim](https://github.com/mr-u0b0dy/crazy-coverage.nvim) ⭐ 20 | 🐛 4 | 🌐 Lua | 📅 2026-09-18 - Display code coverage.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,929 | 🐛 86 | 🌐 Lua | 📅 2026-05-24 - A task runner and job management plugin.
...
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,224 | 🐛 40 | 🌐 Python | 📅 2026-07-03 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
* [CRAG666/code\_runner.nvim](https://github.com/CRAG666/code_runner.nvim) ⭐ 694 | 🐛 2 | 🌐 Lua | 📅 2026-08-20 - The best code runner you could have, with super powers.
...
* [Civitasv/cmake-tools.nvim](https://github.com/Civitasv/cmake-tools.nvim) ⭐ 559 | 🐛 13 | 🌐 Lua | 📅 2026-08-31 - CMake integration.
...
* [wurli/jet.nvim](https://github.com/wurli/jet.nvim) ⭐ 26 | 🐛 1 | 🌐 Lua | 📅 2026-09-18 - A LSP-enabled, extensible Jupyter client that just works.
...
* [JulOuellet/bzl.nvim](https://github.com/JulOuellet/bzl.nvim) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - Bazel integration: target picker and tree, run/test/build with streaming output, and LSP support for Bazel-managed dependencies.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` with framework for writing extensive plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
...
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,119 | 🐛 22 | 🌐 Lua | 📅 2026-08-22 - UI Component Library.
...
* [bfredl/nvim-luadev](https://github.com/bfredl/nvim-luadev) ⭐ 288 | 🐛 2 | 🌐 Lua | 📅 2023-03-13 - REPL/debug console Lua plugins. The `:Luadev` command will open an scratch window which will show output from executing Lua code.
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 223 | 🐛 2 | 🌐 Lua | 📅 2026-09-13 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [saghen/blink.lib](https://github.com/saghen/blink.lib) ⭐ 65 | 🐛 7 | 🌐 Lua | 📅 2026-09-18 - Generic utilities for all other `blink.*` plugins.
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 57 | 🐛 10 | 🌐 Lua | 📅 2026-09-18 - A GitHub action that publishes your plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-05-26 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 23,629 | 🐛 19 | 🌐 Go | 📅 2026-08-29 or compatible encryption tools for cryptographic safety.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for enhanced Git integration with current editor process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 7,109 | 🐛 34 | 🌐 Lua | 📅 2026-09-16 - Git integration: signs, hunk actions, blame, etc.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,629 | 🐛 204 | 🌐 Lua | 📅 2026-08-22 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,364 | 🐛 52 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,563 | 🐛 71 | 🌐 Lua | 📅 2026-09-15 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 401 | 🐛 19 | 🌐 Lua | 📅 2026-09-18 - Review pull requests and manage other GitLab resources.
...
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 335 | 🐛 11 | 🌐 Lua | 📅 2026-09-08 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 301 | 🐛 1 | 🌐 Go | 📅 2026-09-11 - A TUI native Git mergetool with 3 panes.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 127 | 🐛 7 | 🌐 Lua | 📅 2026-08-12 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 32,237 | 🐛 443 | 🌐 Rust | 📅 2026-09-19, with enhanced navigational features.
* [moyiz/git-dev.nvim](https://github.com/moyiz/git-dev.nvim) ⭐ 114 | 🐛 2 | 🌐 Lua | 📅 2026-04-13 - Open remote Git repositories while editing.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,380 | 🐛 246 | 🌐 Lua | 📅 2026-08-28 - Work with GitHub issues and PRs.
...
* [justinmk/guh.nvim](https://github.com/justinmk/guh.nvim) ⭐ 218 | 🐛 23 | 🌐 Lua | 📅 2026-06-25 - View any GitHub object, including CI logs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 4,243 | 🐛 29 | 🌐 Lua | 📅 2026-08-22 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [abecodes/tabout.nvim](https://github.com/abecodes/tabout.nvim) ⭐ 880 | 🐛 7 | 🌐 Lua | 📅 2024-12-10 - Jump out of bracket pairs, quotes, objects, etc.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,307 | 🐛 40 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [chrisgrieser/nvim-recorder](https://github.com/chrisgrieser/nvim-recorder) ⭐ 290 | 🐛 2 | 🌐 Lua | 📅 2026-08-03 - Simplifying and improving how you interact with macros.
* [nvimtools/hydra.nvim](https://github.com/nvimtools/hydra.nvim) ⭐ 284 | 🐛 10 | 🌐 Lua | 📅 2025-05-03 - Create custom submodes and menus. Port of Emacs Hydra. Maintained fork of anuvyklack/hydra.nvim.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 2,071 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
* [windwp/nvim-autopairs](https://github.com/windwp/nvim-autopairs) ⭐ 4,099 | 🐛 16 | 🌐 Lua | 📅 2026-08-23 - A minimalist autopairs written by Lua.
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,229 | 🐛 32 | 🌐 Janet | 📅 2026-08-02 - Shows floating hover with the current function/block context.
...
* [Wansmer/treesj](https://github.com/Wansmer/treesj) ⭐ 1,358 | 🐛 10 | 🌐 Lua | 📅 2026-05-28 - Splitting/joining blocks of code like arrays, hashes, statements, objects, dictionaries, etc. Using Tree-sitter. Inspired by greatest splitjoin.vim.
* [gbprod/yanky.nvim](https://github.com/gbprod/yanky.nvim) ⭐ 1,286 | 🐛 35 | 🌐 Lua | 📅 2026-09-16 - Improved Yank and Put functionalities.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 967 | 🐛 16 | 🌐 Lua | 📅 2026-09-13 - Center the currently focused buffer to the middle of your terminal.
...
* [nacro90/numb.nvim](https://github.com/nacro90/numb.nvim) ⭐ 872 | 🐛 1 | 🌐 Lua | 📅 2026-08-03 - Peek lines in a non-obtrusive way.
...
* [mizlan/iswap.nvim](https://github.com/mizlan/iswap.nvim) ⭐ 526 | 🐛 10 | 🌐 Lua | 📅 2026-05-29 - Interactively select and swap function arguments, list elements, and more. Powered by Tree-sitter.
...
* [keaising/im-select.nvim](https://github.com/keaising/im-select.nvim) ⭐ 368 | 🐛 11 | 🌐 Lua | 📅 2026-03-18 - Switching and restoring input method automatically depending on the edit mode.
...
* [gregorias/coerce.nvim](https://github.com/gregorias/coerce.nvim) ⭐ 177 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - Change keyword case.
...
* [AckslD/nvim-trevJ.lua](https://github.com/AckslD/nvim-trevJ.lua) ⭐ 169 | 🐛 6 | 🌐 Lua | 📅 2025-07-21 - Does the opposite of join-line (J) for arguments, powered by Tree-sitter.
...
* [Nagato-Yuzuru/bang.nvim](https://github.com/Nagato-Yuzuru/bang.nvim) ⭐ 8 | 🐛 6 | 🌐 Lua | 📅 2026-09-19 - `g!` operator that filters a motion, text object or Visual selection through a shell command, like `!` without the whole-line limit.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [celeste3z/celeste\_comment.nvim](https://github.com/celeste3z/celeste_comment.nvim) ⭐ 43 | 🐛 0 | 🌐 Lua | 📅 2026-09-19 - VSCode-style commenting plugin with support for line and block comments, and textobjects.
...
* [kevinhwang91/nvim-ufo](https://github.com/kevinhwang91/nvim-ufo) ⭐ 2,953 | 🐛 46 | 🌐 Lua | 📅 2026-01-11 - Ultra fold with modern looking and performance boosting.
* [chrisgrieser/nvim-origami](https://github.com/chrisgrieser/nvim-origami) ⭐ 534 | 🐛 3 | 🌐 Lua | 📅 2026-08-03 - Fold with relentless elegance.
...
* [fold-logging.nvim](https://github.com/markosnarinian/fold-logging.nvim) ⭐ 9 | 🐛 1 | 🌐 Lua | 📅 2026-09-18 - Fold logging/debug prints without changing normal folds.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,349 | 🐛 101 | 🌐 Lua | 📅 2026-08-11 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,997 | 🐛 26 | 🌐 Lua | 📅 2026-09-04 - IndentLine replacement in Lua with more features and Tree-sitter support.
...
* [NMAC427/guess-indent.nvim](https://github.com/NMAC427/guess-indent.nvim) ⭐ 664 | 🐛 18 | 🌐 Lua | 📅 2025-03-25 - Automatic indentation style detection.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,861 | 🐛 14 | 🌐 Lua | 📅 2026-09-08 - A small automated session manager.
...
* [nosduco/remote-sshfs.nvim](https://github.com/nosduco/remote-sshfs.nvim) ⭐ 429 | 🐛 21 | 🌐 Lua | 📅 2026-04-05 - Explore, edit, and develop on a remote machine via SSHFS.
...
* [azratul/live-share.nvim](https://github.com/azratul/live-share.nvim) ⭐ 281 | 🐛 3 | 🌐 Lua | 📅 2026-09-01 - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
* [kiyoon/jupynium.nvim](https://github.com/kiyoon/jupynium.nvim) ⭐ 775 | 🐛 13 | 🌐 Python | 📅 2026-04-22 - Selenium-automated Jupyter Notebook with real-time synchronization.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 430 | 🐛 29 | 🌐 Lua | 📅 2026-09-13 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,722 | 🐛 2 | 🌐 Lua | 📅 2026-09-12 - Smart, seamless, directional navigation and resizing of splits.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,191 | 🐛 66 | 🌐 Lua | 📅 2026-04-28 - Solve Leetcode problems.
* [xeluxee/competitest.nvim](https://github.com/xeluxee/competitest.nvim) ⭐ 602 | 🐛 21 | 🌐 Lua | 📅 2025-05-13 - A plugin to automate testcases management and checking for Competitive Programming contests.
...
* [m4xshen/hardtime.nvim](https://github.com/m4xshen/hardtime.nvim) ⭐ 3,847 | 🐛 15 | 🌐 Lua | 📅 2026-09-13 - Helping you establish good command workflow and habit.
...
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 263 | 🐛 17 | 🌐 Lua | 📅 2026-09-18 - A single workflow for GitHub, GitLab, Bitbucket, and Jira.
...
* [gisketch/triforce.nvim](https://github.com/gisketch/triforce.nvim) ⭐ 310 | 🐛 0 | 🌐 Lua | 📅 2026-09-19 - Gamified stat tracker with XP, levels, achievements, and activity heatmaps for your coding sessions with lualine integration.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 103 | 🐛 49 | 🌐 Go | 📅 2026-09-19 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [joryeugene/dadbod-grip.nvim](https://github.com/joryeugene/dadbod-grip.nvim) ⭐ 171 | 🐛 1 | 🌐 Lua | 📅 2026-09-02 - Database editor with inline cell editing, staged mutations with live SQL preview, schema browser, DDL, AI SQL generation, FK navigation, and DuckDB/Parquet support.
...
* [SpaceVim/SpaceVim](https://spacevim.org) - A community-driven modular distribution, inspired by [spacemacs](https://github.com/syl20bnr/spacemacs) ⭐ 24,559 | 🐛 62 | 🌐 Emacs Lisp | 📅 2026-09-15.

<!--lint enable double-link -->

* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 31,490 | 🐛 18 | 🌐 Lua | 📅 2026-09-14 - A launch point for your personal configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,490 | 🐛 3 | 🌐 Lua | 📅 2026-07-03 - An attempt to make the built-in CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 27,512 | 🐛 77 | 🌐 Lua | 📅 2026-09-08 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,417 | 🐛 4 | 🌐 Lua | 📅 2026-09-15 - A well-configured and structured configuration with NixOS support.
* [CosmicNvim/CosmicNvim](https://github.com/CosmicNvim/CosmicNvim) ⭐ 1,162 | 🐛 0 | 🌐 Lua | 📅 2026-09-18 - CosmicNvim is a lightweight and opinionated config for web development, specifically designed to provide a COSMIC programming experience.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 476 | 🐛 2 | 🌐 Lua | 📅 2026-09-19 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,143 | 🐛 17 | 🌐 Rust | 📅 2026-09-19 - A cross-platform, easy to use version manager.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 64 | 🐛 0 | 🌐 Nix | 📅 2026-09-18 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [nvim-mini/mini.nvim#mini.input](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-input.md) ⭐ 9,530 | 🐛 37 | 🌐 Lua | 📅 2026-09-19 - Module of `mini.nvim` for getting user input with fully customizable key and view handling. Can show as floating window, statusline/tabline/winbar, virtual line/text. Provides `vim.ui.input()` implementation.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,817 | 🐛 31 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
...
* [ChuYanLon/chad46](https://github.com/ChuYanLon/chad46) ⭐ 8 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-19 - 94 themes with 44 highlight integrations, daily synced from NvChad/base46.
