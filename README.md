...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 21,504 | 🐛 66 | 🌐 Lua | 📅 2026-06-29 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [zuqini/zpack.nvim](https://github.com/zuqini/zpack.nvim) ⭐ 151 | 🐛 0 | 🌐 Lua | 📅 2026-08-20 - A thin layer on top of `vim.pack` to support lazy-loading and `lazy.nvim`'s declarative spec.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,912 | 🐛 34 | 🌐 Lua | 📅 2026-08-30 - Quickstart configurations for the LSP client.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 1,024 | 🐛 11 | 🌐 Lua | 📅 2026-08-31 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,832 | 🐛 98 | 🌐 JavaScript | 📅 2026-08-31 catalog.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,458 | 🐛 276 | 🌐 Lua | 📅 2026-06-19 - Easily install and manage LSP servers, DAP servers, linters, and formatters.
...
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 3,099 | 🐛 20 | 🌐 Lua | 📅 2026-08-31 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 609 | 🐛 21 | 🌐 Lua | 📅 2026-08-31 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [creativenull/efmls-configs-nvim](https://github.com/creativenull/efmls-configs-nvim) ⭐ 319 | 🐛 2 | 🌐 Lua | 📅 2026-08-11 - An unofficial collection of linters and formatters configured for efm-langserver to work with built-in LSP.
...
* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,887 | 🐛 19 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,542 | 🐛 99 | 🌐 Lua | 📅 2026-08-31 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 120 | 🐛 2 | 🌐 Lua | 📅 2026-08-31 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-07-16 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 48,948 | 🐛 36 | 🌐 C | 📅 2026-08-31.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,096 | 🐛 22 | 🌐 Lua | 📅 2026-08-26 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,686 | 🐛 64 | 🌐 Vim Script | 📅 2026-08-11.
* [ms-jpq/coq\_nvim](https://github.com/ms-jpq/coq_nvim) ⭐ 3,813 | 🐛 186 | 🌐 Lua | 📅 2026-08-31 - Fast as FUCK completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,136 | 🐛 42 | 🌐 Lua | 📅 2026-08-28 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,826 | 🐛 12 | 🌐 Lua | 📅 2026-08-30 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,798 | 🐛 6 | 🌐 Lua | 📅 2026-08-21 - OpenCode AI assistant integration.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,390 | 🐛 13 | 🌐 Lua | 📅 2026-08-14 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [Exafunction/windsurf.nvim](https://github.com/Exafunction/windsurf.nvim) ⭐ 1,291 | 🐛 116 | 🌐 Lua | 📅 2026-04-02 - Free, ultrafast Copilot alternative. Supports LSP and Tree-sitter.
...
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 463 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-31 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [teocns/neocursor.nvim](https://github.com/teocns/neocursor.nvim) ⭐ 62 | 🐛 0 | 🌐 Lua | 📅 2026-08-04 - Next-edit predictions, cursor jumps, and ghost text, all driven by an existing Cursor session instead of an API key.
...
* [saya-ashen/agent-workbench.nvim](https://github.com/saya-ashen/agent-workbench.nvim) ⭐ 25 | 🐛 0 | 🌐 Lua | 📅 2026-08-29 - Workspace frontend for pi.dev with sessions, diff review, and persistent shell worksheets.
* [taigrr/neocrush.nvim](https://github.com/taigrr/neocrush.nvim) ⭐ 23 | 🐛 0 | 🌐 Lua | 📅 2026-08-22 - Integration with Crush AI coding assistant, with edit highlighting, auto-focus, Telescope support, terminal and version management.
...
* [zgs225/pi2.nvim](https://github.com/zgs225/pi2.nvim) ⭐ 18 | 🐛 0 | 🌐 Lua | 📅 2026-08-31 - Frontend for the [pi](https://pi.dev) coding agent with in-editor chat, reviewed diffs, session-tree navigation, and extension prompts.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 9 | 🐛 4 | 🌐 Lua | 📅 2026-08-31 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 12,435 | 🐛 681 | 🌐 Python | 📅 2026-08-22 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,699 | 🐛 36 | 🌐 Lua | 📅 2026-07-04 - Everything you need for a painless Java experience.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 570 | 🐛 38 | 🌐 Lua | 📅 2026-08-31 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [abidibo/nvim-httpyac](https://github.com/abidibo/nvim-httpyac) ⭐ 18 | 🐛 0 | 🌐 Lua | 📅 2026-08-31 - Provides integration with `httpYac`.
...
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,967 | 🐛 12 | 🌐 Lua | 📅 2026-08-11 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,614 | 🐛 4 | 🌐 Lua | 📅 2026-08-14 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [itsfernn/vimtex-follow](https://github.com/itsfernn/vimtex-follow) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-08-04 - Adds a toggleable "follow mode", synchronizing your PDF viewer with your cursor position.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 14,361 | 🐛 270 | 🌐 Tree-sitter Query | 📅 2026-08-31 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,284 | 🐛 11 | 🌐 Lua | 📅 2026-06-08 - A plugin for adding/changing/deleting surrounding delimiter pairs.
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,811 | 🐛 125 | 🌐 Tree-sitter Query | 📅 2026-07-19 - Create your own textobjects using Tree-sitter queries.
* [romus204/tree-sitter-manager.nvim](https://github.com/romus204/tree-sitter-manager.nvim) ⭐ 869 | 🐛 14 | 🌐 Tree-sitter Query | 📅 2026-08-23 - A lightweight Tree-sitter parser manager for Neovim 0.12+.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,426 | 🐛 134 | 🌐 Lua | 📅 2026-05-19 - A snippet engine written in Lua.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 9,212 | 🐛 146 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [nvim-pack/nvim-spectre](https://github.com/nvim-pack/nvim-spectre) ⭐ 2,409 | 🐛 15 | 🌐 Lua | 📅 2025-05-19 - Search and replace panel.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,753 | 🐛 464 | 🌐 Lua | 📅 2026-08-17 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,753 | 🐛 464 | 🌐 Lua | 📅 2026-08-17 A highly extensible fuzzy finder over lists.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 10,318 | 🐛 75 | 🌐 Rust | 📅 2026-08-31 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 8,034 | 🐛 138 | 🌐 Lua | 📅 2026-05-25 - A modern fuzzy-finder to navigate your editor.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,423 | 🐛 10 | 🌐 Lua | 📅 2026-08-13 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,939 | 🐛 4 | 🌐 Rust | 📅 2026-08-22 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 371 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,090 | 🐛 140 | 🌐 Rust | 📅 2026-08-31, a smart directory picker that tracks your usage.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,632 | 🐛 101 | 🌐 Lua | 📅 2026-08-12 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,863 | 🐛 151 | 🌐 Lua | 📅 2026-06-02 - Edit your filesystem like a buffer.
...
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,855 | 🐛 10 | 🌐 Lua | 📅 2026-08-31 - Integration with the Yazi terminal file manager.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,689 | 🐛 93 | 🌐 Python | 📅 2026-08-31 - File manager. Better than NERDTree.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 464 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,852 | 🐛 4 | 🌐 C | 📅 2026-08-31 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 183 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,382 | 🐛 897 | 🌐 Python | 📅 2026-08-31 integration.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 100 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 41,836 | 🐛 66 | 🌐 Rust | 📅 2026-08-31).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 199 | 🐛 2 | 🌐 Lua | 📅 2026-08-30 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [j-morano/buffer\_manager.nvim](https://github.com/j-morano/buffer_manager.nvim) ⭐ 400 | 🐛 5 | 🌐 Lua | 📅 2026-02-04 - Add one or more buffers, reorder them, save them inside a file or just delete them very easily from a small floating window.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,121 | 🐛 5 | 🌐 Lua | 📅 2026-07-14 - A high-performance color highlighter which has no external dependencies.
* [uga-rosa/ccc.nvim](https://github.com/uga-rosa/ccc.nvim) ⭐ 981 | 🐛 12 | 🌐 Lua | 📅 2025-05-06 - Super powerful color picker / colorizer plugin.
...
* [max397574/colortils.nvim](https://github.com/max397574/colortils.nvim) ⭐ 430 | 🐛 8 | 🌐 Lua | 📅 2025-01-10 - Provides utils to work with colors (picker, conversion).
...
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 4,187 | 🐛 6 | 🌐 Vim Script | 📅 2026-06-08 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 676 | 🐛 0 | 🌐 Lua | 📅 2026-07-22 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
...
* [ThorstenRhau/token](https://github.com/ThorstenRhau/token) ⭐ 229 | 🐛 0 | 🌐 Emacs Lisp | 📅 2026-08-31 - ***`[TS][LSP][L/D][Lua]`*** Token has warm tones and careful contrast, with full Tree-sitter and LSP integration.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 3,082 | 🐛 5 | 🌐 Lua | 📅 2026-05-15 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
...
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,361 | 🐛 90 | 🌐 Lua | 📅 2026-05-10 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
* [uloco/bluloco.nvim](https://github.com/uloco/bluloco.nvim) ⭐ 457 | 🐛 11 | 🌐 Lua | 📅 2026-08-30 - ***`[TS][LSP][L/D][Lua]`*** A fancy and sophisticated colorscheme for night and day coding. Supports LSP, Tree-sitter and all the plugins you love.
* [ramojus/mellifluous.nvim](https://github.com/ramojus/mellifluous.nvim) ⭐ 450 | 🐛 3 | 🌐 Lua | 📅 2026-04-20 - ***`[TS][LSP][L/D][Lua]`*** Pleasant and productive colorscheme.
...
* [hyperb1iss/silkcircuit](https://github.com/hyperb1iss/silkcircuit) ⭐ 59 | 🐛 1 | 🌐 Lua | 📅 2026-08-31 - ***`[TS][LSP][L/D][Lua]`*** Vibrant cyberpunk color system with five variants, 40+ plugin integrations, WCAG AA compliant. Supports multiple editors, terminals and CLI tools.
...
* [art220/dancheong.nvim](https://github.com/art220/dancheong.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-08-03 - ***`[TS][LSP][L/D][Lua]`*** Four variants drawn from dancheong, the 1,500-year-old Korean temple-painting palette, with every color contrast-gated at build time and a matching lualine theme.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [RRethy/base16-nvim](https://github.com/RRethy/base16-nvim) ⭐ 653 | 🐛 2 | 🌐 Lua | 📅 2026-08-10 - A base16 colorscheme builder. Includes support for Tree-sitter and LSP highlight groups.
...
* [Senal-D-A-Gunaratna/matugen.nvim](https://github.com/Senal-D-A-Gunaratna/matugen.nvim) ⭐ 24 | 🐛 0 | 🌐 Lua | 📅 2026-08-27 - Material You colorscheme generator using an external template system. Supports Tree-sitter, LSP, and Lua.
...
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,594 | 🐛 15 | 🌐 Lua | 📅 2026-05-31 - IDE-like breadcrumbs, out of the box.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 8,109 | 🐛 271 | 🌐 Lua | 📅 2026-05-31 - Easily configurable, blazingly fast statusline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,365 | 🐛 105 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,488 | 🐛 221 | 🌐 Lua | 📅 2026-08-14 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,871 | 🐛 151 | 🌐 Lua | 📅 2026-08-20 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 2,132 | 🐛 49 | 🌐 Lua | 📅 2026-08-31 - Plugin for Obsidian, written in Lua.
...
* [0xJohnnyboy/scretch.nvim](https://github.com/0xJohnnyboy/scretch.nvim) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2026-08-20 - Create and manage scratch files, scratch templates, with picker integrations.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 32 | 🐛 1 | 🌐 Lua | 📅 2026-08-30 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,808 | 🐛 80 | 🌐 Go | 📅 2026-08-13 inside the editor.
...
* [ChuYanLon/telegram.nvim](https://github.com/ChuYanLon/telegram.nvim) ⭐ 15 | 🐛 0 | 🌐 Lua | 📅 2026-08-09 - A Telegram chat client powered by TDLib supporting real-time messaging, group management, and media preview.
...
* [StefanBartl/color\_my\_ascii.nvim](https://github.com/StefanBartl/color_my_ascii.nvim) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-08-31 - Colorful highlighting of ASCII art in Markdown code blocks.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 682 | 🐛 17 | 🌐 Lua | 📅 2026-05-02 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 2,008 | 🐛 8 | 🌐 Lua | 📅 2026-04-15 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [jlesquembre/nterm.nvim](https://github.com/jlesquembre/nterm.nvim) ⭐ 58 | 🐛 1 | 🌐 Lua | 📅 2026-08-25 - Interact with the terminal, with notifications.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,234 | 🐛 32 | 🌐 Lua | 📅 2026-06-20 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,364 | 🐛 108 | 🌐 Lua | 📅 2026-07-14 - A UI for nvim-dap.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,113 | 🐛 102 | 🌐 Lua | 📅 2026-08-16 - An extensible framework for interacting with tests within your editor.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,923 | 🐛 84 | 🌐 Lua | 📅 2026-05-24 - A task runner and job management plugin.
...
* [Vigemus/iron.nvim](https://github.com/Vigemus/iron.nvim) ⭐ 1,356 | 🐛 55 | 🌐 Lua | 📅 2026-08-30 - Interactive REPLs of over 30 languages embedded.
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,217 | 🐛 40 | 🌐 Python | 📅 2026-07-03 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` with framework for writing extensive plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,491 | 🐛 158 | 🌐 Lua | 📅 2026-04-10 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,112 | 🐛 22 | 🌐 Lua | 📅 2026-08-22 - UI Component Library.
...
* [lumen-oss/lz.n](https://github.com/lumen-oss/lz.n) ⭐ 291 | 🐛 0 | 🌐 Lua | 📅 2026-08-30 - A simple lazy loading library for plugins.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-05-26 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 23,380 | 🐛 18 | 🌐 Go | 📅 2026-08-29 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,137 | 🐛 91 | 🌐 Fennel | 📅 2026-08-28 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
...
* [Olical/nfnl](https://github.com/Olical/nfnl) ⭐ 363 | 🐛 8 | 🌐 Fennel | 📅 2026-08-14 - Streamlined successor to Aniseed, compiling Fennel to Lua on file write.
...
* [vuki656/package-info.nvim](https://github.com/vuki656/package-info.nvim) ⭐ 598 | 🐛 0 | 🌐 Lua | 📅 2026-08-25 - Display latest package version as virtual text in package.json.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for enhanced Git integration with current editor process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
...
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,600 | 🐛 200 | 🌐 Lua | 📅 2026-08-22 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,350 | 🐛 53 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,537 | 🐛 84 | 🌐 Lua | 📅 2026-08-30 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
* [f-person/git-blame.nvim](https://github.com/f-person/git-blame.nvim) ⭐ 1,099 | 🐛 12 | 🌐 Lua | 📅 2025-11-05 - Show Git blame info.
...
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 315 | 🐛 10 | 🌐 Lua | 📅 2026-08-27 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 127 | 🐛 6 | 🌐 Lua | 📅 2026-08-12 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 32,042 | 🐛 432 | 🌐 Rust | 📅 2026-08-02, with enhanced navigational features.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 4,225 | 🐛 27 | 🌐 Lua | 📅 2026-08-22 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [kkew3/jieba.vim](https://github.com/kkew3/jieba.vim) ⭐ 60 | 🐛 3 | 🌐 Rust | 📅 2026-08-24 - Word motions and word text objects for Chinese.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,271 | 🐛 39 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 132 | 🐛 0 | 🌐 Lua | 📅 2026-06-20 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,811 | 🐛 125 | 🌐 Tree-sitter Query | 📅 2026-07-19 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
* [petertriho/nvim-scrollbar](https://github.com/petertriho/nvim-scrollbar) ⭐ 1,069 | 🐛 30 | 🌐 Lua | 📅 2026-08-16 - Extensible scrollbar that shows diagnostics and search results.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,224 | 🐛 31 | 🌐 Janet | 📅 2026-08-02 - Shows floating hover with the current function/block context.
...
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,523 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - Adds support for multiple cursors which work how you expect.
...
* [keaising/im-select.nvim](https://github.com/keaising/im-select.nvim) ⭐ 361 | 🐛 10 | 🌐 Lua | 📅 2026-03-18 - Switching and restoring input method automatically depending on the edit mode.
...
* [ptdewey/yankbank-nvim](https://github.com/ptdewey/yankbank-nvim) ⭐ 124 | 🐛 1 | 🌐 Lua | 📅 2026-04-19 - Enable streamlined access to recent yanks and deletions in a quick-access popup menu.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
* [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim) ⭐ 4,667 | 🐛 83 | 🌐 Lua | 📅 2024-08-19 - Smart and powerful comment plugin. Supports commentstring, motions, dot-repeat and more.
...
* [danymat/neogen](https://github.com/danymat/neogen) ⭐ 1,658 | 🐛 44 | 🌐 Lua | 📅 2026-01-10 - A better annotation generator which supports multiple languages and annotation conventions.
...
* [celeste3z/celeste\_comment.nvim](https://github.com/celeste3z/celeste_comment.nvim) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2026-08-30 - VSCode-style commenting plugin with support for line and block comments, and textobjects.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,326 | 🐛 97 | 🌐 Lua | 📅 2026-08-11 - A lightweight formatting engine that plays nice with LSP.
* [sbdchd/neoformat](https://github.com/sbdchd/neoformat) ⭐ 2,047 | 🐛 130 | 🌐 Vim Script | 📅 2026-04-13 - A code formatting runner.
* [mhartington/formatter.nvim](https://github.com/mhartington/formatter.nvim) ⭐ 1,451 | 🐛 44 | 🌐 Lua | 📅 2025-05-29 - A format runner written in Lua.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
...
* [NMAC427/guess-indent.nvim](https://github.com/NMAC427/guess-indent.nvim) ⭐ 657 | 🐛 18 | 🌐 Lua | 📅 2025-03-25 - Automatic indentation style detection.
* [nvimdev/indentmini.nvim](https://github.com/nvimdev/indentmini.nvim) ⭐ 283 | 🐛 2 | 🌐 Lua | 📅 2026-01-04 - A minimal and blazing fast indentline plugin by using the `nvim_set_decoration_provide` API function.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,855 | 🐛 16 | 🌐 Lua | 📅 2026-08-15 - A small automated session manager.
* [folke/persistence.nvim](https://github.com/folke/persistence.nvim) ⭐ 1,009 | 🐛 9 | 🌐 Lua | 📅 2025-10-28 - Simple automated session management.
...
* [olimorris/persisted.nvim](https://github.com/olimorris/persisted.nvim) ⭐ 543 | 🐛 0 | 🌐 Lua | 📅 2026-08-25 - Simple session management with Git branching, autosave/autoload and Telescope support.
...
* [azratul/live-share.nvim](https://github.com/azratul/live-share.nvim) ⭐ 279 | 🐛 3 | 🌐 Lua | 📅 2026-08-31 - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,718 | 🐛 23 | 🌐 Lua | 📅 2026-08-29 - Smart, seamless, directional navigation and resizing of splits.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,167 | 🐛 63 | 🌐 Lua | 📅 2026-04-28 - Solve Leetcode problems.
...
* [m4xshen/hardtime.nvim](https://github.com/m4xshen/hardtime.nvim) ⭐ 3,841 | 🐛 15 | 🌐 Lua | 📅 2026-07-20 - Helping you establish good command workflow and habit.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 103 | 🐛 29 | 🌐 Go | 📅 2026-08-31 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [SpaceVim/SpaceVim](https://spacevim.org) - A community-driven modular distribution, inspired by [spacemacs](https://github.com/syl20bnr/spacemacs) ⭐ 24,564 | 🐛 61 | 🌐 Emacs Lisp | 📅 2026-08-29.

<!--lint enable double-link -->

* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 31,373 | 🐛 23 | 🌐 Lua | 📅 2026-08-07 - A launch point for your personal configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,448 | 🐛 3 | 🌐 Lua | 📅 2026-07-03 - An attempt to make the built-in CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 27,334 | 🐛 77 | 🌐 Lua | 📅 2026-06-02 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,422 | 🐛 3 | 🌐 Lua | 📅 2026-08-15 - A well-configured and structured configuration with NixOS support.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 466 | 🐛 2 | 🌐 Lua | 📅 2026-08-29 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,142 | 🐛 17 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, easy to use version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 38 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - Another version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 64 | 🐛 0 | 🌐 Nix | 📅 2026-08-30 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [nvim-mini/mini.nvim#mini.input](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-input.md) ⭐ 9,476 | 🐛 37 | 🌐 Lua | 📅 2026-08-30 - Module of `mini.nvim` for getting user input with fully customizable key and view handling. Can show as floating window, statusline/tabline/winbar, virtual line/text. Provides `vim.ui.input()` implementation.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,814 | 🐛 32 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
* [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) ⭐ 3,569 | 🐛 80 | 🌐 Lua | 📅 2025-09-06 - A fancy, configurable, notification manager.
...
* [akrawchyk/awesome-vim#tools](https://github.com/akrawchyk/awesome-vim#tools) ⭐ 2,129 | 🐛 11 | 📅 2025-06-06 - A short list of Vim plugins and helpful guides.
