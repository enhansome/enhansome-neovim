...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 21,457 | 🐛 65 | 🌐 Lua | 📅 2026-06-29 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,894 | 🐛 34 | 🌐 Lua | 📅 2026-08-24 - Quickstart configurations for the LSP client.
...
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,773 | 🐛 45 | 🌐 Lua | 📅 2026-08-20 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
...
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,331 | 🐛 73 | 🌐 Lua | 📅 2026-06-02 - A code outline window for skimming and quick navigation.
* [onsails/lspkind.nvim](https://github.com/onsails/lspkind.nvim) ⭐ 1,692 | 🐛 15 | 🌐 Lua | 📅 2026-01-29 - The plugin adds VSCode-like icons to LSP completions.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 1,024 | 🐛 11 | 🌐 Lua | 📅 2026-08-24 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,828 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-24 catalog.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,453 | 🐛 276 | 🌐 Lua | 📅 2026-06-19 - Easily install and manage LSP servers, DAP servers, linters, and formatters.
* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,260 | 🐛 12 | 🌐 Lua | 📅 2026-08-10 - A reloaded `null-ls.nvim` to use your editor as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 3,096 | 🐛 20 | 🌐 Lua | 📅 2026-08-25 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 608 | 🐛 21 | 🌐 Lua | 📅 2026-08-25 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
* [zeioth/garbage-day.nvim](https://github.com/Zeioth/garbage-day.nvim) ⭐ 524 | 🐛 5 | 🌐 Lua | 📅 2026-08-19 - Garbage collector that stops inactive LSP clients to free RAM.
...
* [nemanjamalesija/ts-expand-hover.nvim](https://github.com/nemanjamalesija/ts-expand-hover.nvim) ⭐ 68 | 🐛 2 | 🌐 Lua | 📅 2026-03-06 - Progressively expand and collapse TypeScript type aliases inside the hover float.
...
* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,882 | 🐛 19 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,478 | 🐛 303 | 🌐 Lua | 📅 2026-07-09 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,531 | 🐛 98 | 🌐 Lua | 📅 2026-08-25 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 119 | 🐛 1 | 🌐 Lua | 📅 2026-08-24 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-07-16 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 48,811 | 🐛 31 | 🌐 C | 📅 2026-08-25.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,095 | 🐛 21 | 🌐 Lua | 📅 2026-08-24 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,683 | 🐛 63 | 🌐 Vim Script | 📅 2026-08-11.
* [ms-jpq/coq\_nvim](https://github.com/ms-jpq/coq_nvim) ⭐ 3,815 | 🐛 187 | 🌐 Lua | 📅 2026-08-23 - Fast as FUCK completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,135 | 🐛 44 | 🌐 Lua | 📅 2026-08-25 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,822 | 🐛 11 | 🌐 Lua | 📅 2026-08-24 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,789 | 🐛 5 | 🌐 Lua | 📅 2026-08-21 - OpenCode AI assistant integration.
...
* [azorng/goose.nvim](https://github.com/azorng/goose.nvim) ⭐ 316 | 🐛 5 | 🌐 Lua | 📅 2026-08-22 - Seamless integration with [goose](https://block.github.io/goose) - work with a powerful AI agent without leaving your editor.
...
* [zgs225/pi2.nvim](https://github.com/zgs225/pi2.nvim) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2026-08-20 - Frontend for the [pi](https://pi.dev) coding agent with in-editor chat, reviewed diffs, session-tree navigation, and extension prompts.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 9 | 🐛 4 | 🌐 Lua | 📅 2026-08-25 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 12,404 | 🐛 675 | 🌐 Python | 📅 2026-08-22 tool.
...
* [saya-ashen/agent-workbench.nvim](https://github.com/saya-ashen/agent-workbench.nvim) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2026-08-24 - Workspace frontend for pi.dev with sessions, diff review, and persistent shell worksheets.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,920 | 🐛 293 | 🌐 PHP | 📅 2026-08-22.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,975 | 🐛 264 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,948 | 🐛 12 | 🌐 Lua | 📅 2026-08-11 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,604 | 🐛 4 | 🌐 Lua | 📅 2026-08-14 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 286 | 🐛 10 | 🌐 Lua | 📅 2026-08-23 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [kibi2/tirenvi.nvim](https://github.com/kibi2/tirenvi.nvim) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2026-08-19 - Edit Markdown and CSV tables with lossless round-trip.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 14,330 | 🐛 270 | 🌐 Tree-sitter Query | 📅 2026-08-23 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 2,001 | 🐛 0 | 🌐 Lua | 📅 2026-08-13 - Buffer-based live search and replace with full power of `rg` flags. Grug like.
...
* [2KAbhishek/seeker.nvim](https://github.com/2KAbhishek/seeker.nvim) ⭐ 137 | 🐛 0 | 🌐 Lua | 📅 2026-08-25 - Progressive file seeker built on top of `snacks.nvim`.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,730 | 🐛 462 | 🌐 Lua | 📅 2026-08-17 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,730 | 🐛 462 | 🌐 Lua | 📅 2026-08-17 A highly extensible fuzzy finder over lists.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 10,141 | 🐛 72 | 🌐 Rust | 📅 2026-08-25 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 8,012 | 🐛 135 | 🌐 Lua | 📅 2026-05-25 - A modern fuzzy-finder to navigate your editor.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,421 | 🐛 10 | 🌐 Lua | 📅 2026-08-13 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,934 | 🐛 4 | 🌐 Rust | 📅 2026-08-22 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 370 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,825 | 🐛 137 | 🌐 Rust | 📅 2026-08-24, a smart directory picker that tracks your usage.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,627 | 🐛 100 | 🌐 Lua | 📅 2026-08-12 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,840 | 🐛 150 | 🌐 Lua | 📅 2026-06-02 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,576 | 🐛 174 | 🌐 Lua | 📅 2026-08-19 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,850 | 🐛 9 | 🌐 Lua | 📅 2026-08-24 - Integration with the Yazi terminal file manager.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,691 | 🐛 93 | 🌐 Python | 📅 2026-08-25 - File manager. Better than NERDTree.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 464 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,829 | 🐛 5 | 🌐 C | 📅 2026-08-17 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 183 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,368 | 🐛 899 | 🌐 Python | 📅 2026-08-15 integration.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 100 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 41,665 | 🐛 65 | 🌐 Rust | 📅 2026-08-25).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 198 | 🐛 2 | 🌐 Lua | 📅 2026-08-25 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 8,176 | 🐛 20 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 4,180 | 🐛 6 | 🌐 Vim Script | 📅 2026-06-08 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [nyoom-engineering/oxocarbon.nvim](https://github.com/nyoom-engineering/oxocarbon.nvim) ⭐ 1,628 | 🐛 21 | 🌐 Fennel | 📅 2026-08-09 - ***`[TS][LSP][L/D][Lua]`*** A dark and light theme written in Fennel, inspired by IBM Carbon.
* [dracula/vim](https://github.com/dracula/vim) ⭐ 1,391 | 🐛 8 | 🌐 Vim Script | 📅 2026-08-09 - ***`[TS][LSP]`*** Famous beautiful dark powered theme.
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,320 | 🐛 0 | 🌐 Lua | 📅 2026-05-30 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [bluz71/vim-nightfly-colors](https://github.com/bluz71/vim-nightfly-colors) ⭐ 939 | 🐛 0 | 🌐 Lua | 📅 2026-05-30 - ***`[TS][LSP][Lua]`*** A dark midnight colorscheme with Tree-sitter support.
...
* [neanias/everforest-nvim](https://github.com/neanias/everforest-nvim) ⭐ 458 | 🐛 8 | 🌐 Lua | 📅 2026-07-27 - ***`[TS][LSP][L/D][Lua]`*** A Lua port of the Everforest colour scheme.
* [tanvirtin/monokai.nvim](https://github.com/tanvirtin/monokai.nvim) ⭐ 392 | 🐛 15 | 🌐 Lua | 📅 2023-12-02 - ***`[TS][LSP][Lua]`*** Monokai theme written in Lua.
* [nvimdev/zephyr-nvim](https://github.com/nvimdev/zephyr-nvim) ⭐ 378 | 🐛 3 | 🌐 Lua | 📅 2022-12-31 - ***`[TS][Lua]`*** A dark colorscheme with Tree-sitter support.
...
* [ThorstenRhau/token](https://github.com/ThorstenRhau/token) ⭐ 225 | 🐛 0 | 🌐 Emacs Lisp | 📅 2026-08-19 - ***`[TS][LSP][L/D][Lua]`*** Token has warm tones and careful contrast, with full Tree-sitter and LSP integration.
...
* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
...
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,352 | 🐛 90 | 🌐 Lua | 📅 2026-05-10 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
* [uloco/bluloco.nvim](https://github.com/uloco/bluloco.nvim) ⭐ 455 | 🐛 11 | 🌐 Lua | 📅 2026-08-23 - ***`[TS][LSP][L/D][Lua]`*** A fancy and sophisticated colorscheme for night and day coding. Supports LSP, Tree-sitter and all the plugins you love.
...
* [oxfist/night-owl.nvim](https://github.com/oxfist/night-owl.nvim) ⭐ 352 | 🐛 5 | 🌐 Lua | 📅 2024-09-12 - ***`[TS][LSP][Lua]`*** A [Night Owl colorscheme port from VSCode](https://github.com/sdras/night-owl-vscode-theme) ⭐ 2,956 | 🐛 48 | 📅 2024-12-31 with support for Tree-sitter and semantic tokens.
...
* [diegoulloao/neofusion.nvim](https://github.com/diegoulloao/neofusion.nvim) ⭐ 235 | 🐛 0 | 🌐 Lua | 📅 2026-03-02 - ***`[TS][LSP][Lua]`*** A theme compatible with Tree-sitter inspired by `gruvbox.nvim`.
...
* [Verf/deepwhite.nvim](https://github.com/Verf/deepwhite.nvim) ⭐ 181 | 🐛 0 | 🌐 Lua | 📅 2026-06-11 - ***`[TS][LSP][Lua]`*** A light colorscheme inspired by [flatwhite-syntax](https://github.com/biletskyy/flatwhite-syntax) ⭐ 198 | 🐛 15 | 🌐 CSS | 📅 2020-04-27 and [elegant-emacs](https://github.com/rougier/elegant-emacs) ⭐ 1,446 | 🐛 8 | 🌐 Emacs Lisp | 📅 2021-11-22.
...
* [jpwol/thorn.nvim](https://github.com/jpwol/thorn.nvim) ⭐ 128 | 🐛 0 | 🌐 Lua | 📅 2026-05-17 - ***`[TS][LSP][L/D][Lua]`*** A rich green theme with dark and light options. Supports LSP, transparency, many plugins, and more.
...
* [hyperb1iss/silkcircuit](https://github.com/hyperb1iss/silkcircuit) ⭐ 58 | 🐛 2 | 🌐 Lua | 📅 2026-07-26 - ***`[TS][LSP][L/D][Lua]`*** Vibrant cyberpunk color system with five variants, 40+ plugin integrations, WCAG AA compliant. Supports multiple editors, terminals and CLI tools.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 8,098 | 🐛 271 | 🌐 Lua | 📅 2026-05-31 - Easily configurable, blazingly fast statusline.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 208 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,960 | 🐛 37 | 🌐 Vim Script | 📅 2026-07-25 that aims to be as light and simple as possible.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,366 | 🐛 103 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
* [RRethy/vim-illuminate](https://github.com/RRethy/vim-illuminate) ⭐ 2,464 | 🐛 8 | 🌐 Lua | 📅 2026-08-25 - Highlight the word under the cursor with built-in LSP support.
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,403 | 🐛 34 | 🌐 Lua | 📅 2026-08-25 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,384 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
* [max397574/startup.nvim](https://github.com/max397574/startup.nvim) ⭐ 502 | 🐛 10 | 🌐 Lua | 📅 2026-06-07 - The fully customizable greeter.
* [Amansingh-afk/milli.nvim](https://github.com/Amansingh-afk/milli.nvim) ⭐ 310 | 🐛 1 | 🌐 Lua | 📅 2026-07-06 - Animated ASCII splash screens with bundled animations and custom image or GIF support.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,714 | 🐛 16 | 🌐 Lua | 📅 2026-07-22 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,803 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,482 | 🐛 220 | 🌐 Lua | 📅 2026-08-14 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,867 | 🐛 150 | 🌐 Lua | 📅 2026-08-20 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 2,119 | 🐛 64 | 🌐 Lua | 📅 2026-08-25 - Plugin for Obsidian, written in Lua.
...
* [zk-org/zk-nvim](https://github.com/zk-org/zk-nvim) ⭐ 848 | 🐛 0 | 🌐 Lua | 📅 2026-08-25 -  Provides integration with `zk`, a plain text note-taking assistant.
...
* [StefanBartl/color\_my\_ascii.nvim](https://github.com/StefanBartl/color_my_ascii.nvim) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-08-25 - Colorful highlighting of ASCII art in Markdown code blocks.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 678 | 🐛 17 | 🌐 Lua | 📅 2026-05-02 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 40 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,940 | 🐛 59 | 🌐 Rust | 📅 2026-07-04, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,998 | 🐛 8 | 🌐 Lua | 📅 2026-04-15 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,585 | 🐛 92 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
* [kassio/neoterm](https://github.com/kassio/neoterm) ⭐ 1,340 | 🐛 31 | 🌐 Vim Script | 📅 2023-03-09 - Wrapper of some `:terminal` functions.
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 908 | 🐛 28 | 🌐 Lua | 📅 2026-08-13 - Open your kitty scrollback buffer. Ameowzing.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,226 | 🐛 32 | 🌐 Lua | 📅 2026-06-20 - Debug Adapter Protocol client implementation.
...
* [mr-u0b0dy/crazy-coverage.nvim](https://github.com/mr-u0b0dy/crazy-coverage.nvim) ⭐ 19 | 🐛 3 | 🌐 Lua | 📅 2026-05-25 - Display code coverage.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` with framework for writing extensive plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
...
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,564 | 🐛 7 | 🌐 Lua | 📅 2026-03-14 - Faster LuaLS setup.
...
* [lumen-oss/lz.n](https://github.com/lumen-oss/lz.n) ⭐ 289 | 🐛 0 | 🌐 Lua | 📅 2026-08-23 - A simple lazy loading library for plugins.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 57 | 🐛 10 | 🌐 Lua | 📅 2026-08-25 - A GitHub action that publishes your plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-05-26 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 23,316 | 🐛 33 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [Saecki/crates.nvim](https://github.com/Saecki/crates.nvim) ⭐ 1,117 | 🐛 12 | 🌐 Lua | 📅 2026-04-13 - Rust dependency management for `Cargo.toml`.
* [vuki656/package-info.nvim](https://github.com/vuki656/package-info.nvim) ⭐ 597 | 🐛 0 | 🌐 Lua | 📅 2026-08-25 - Display latest package version as virtual text in package.json.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for enhanced Git integration with current editor process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
...
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,529 | 🐛 83 | 🌐 Lua | 📅 2026-08-11 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 397 | 🐛 17 | 🌐 Lua | 📅 2026-08-18 - Review pull requests and manage other GitLab resources.
...
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 303 | 🐛 7 | 🌐 Lua | 📅 2026-08-24 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 127 | 🐛 6 | 🌐 Lua | 📅 2026-08-12 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 31,853 | 🐛 430 | 🌐 Rust | 📅 2026-08-02, with enhanced navigational features.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to go forward/backward with square brackets.
* [ggandor/leap.nvim](https://github.com/ggandor/leap.nvim) ⭐ 5,028 | 🐛 27 | 📅 2026-08-16 - A refined successor of Lightspeed, aiming to establish a widely accepted standard interface extension for moving around in Vim-like editors.
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 4,213 | 🐛 27 | 🌐 Lua | 📅 2026-08-22 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [tris203/precognition.nvim](https://github.com/tris203/precognition.nvim) ⭐ 1,379 | 🐛 1 | 🌐 Lua | 📅 2026-07-26 - Precognition uses virtual text and gutter signs to show available motions.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,263 | 🐛 39 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [windwp/nvim-ts-autotag](https://github.com/windwp/nvim-ts-autotag) ⭐ 2,112 | 🐛 6 | 🌐 Lua | 📅 2026-04-15 - Use Tree-sitter to autoclose and autorename XML, HTML, JSX tag.
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,516 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - Adds support for multiple cursors which work how you expect.
...
* [sQVe/sort.nvim](https://github.com/sQVe/sort.nvim) ⭐ 216 | 🐛 0 | 🌐 Lua | 📅 2026-04-17 - Sorting plugin that intelligently supports line-wise and delimiter sorting.
...
* [nemanjamalesija/smart-paste.nvim](https://github.com/nemanjamalesija/smart-paste.nvim) ⭐ 171 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Automatic indentation of pasted code using a three-tier indent strategy (indentexpr / Tree-sitter / heuristic).
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [celeste3z/celeste\_comment.nvim](https://github.com/celeste3z/celeste_comment.nvim) ⭐ 29 | 🐛 0 | 🌐 Lua | 📅 2026-08-22 - VSCode-style commenting plugin with support for line and block comments, and textobjects.
...
* [chrisgrieser/nvim-origami](https://github.com/chrisgrieser/nvim-origami) ⭐ 527 | 🐛 4 | 🌐 Lua | 📅 2026-08-03 - Fold with relentless elegance.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,318 | 🐛 97 | 🌐 Lua | 📅 2026-08-11 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
...
* [shellRaining/hlchunk.nvim](https://github.com/shellRaining/hlchunk.nvim) ⭐ 916 | 🐛 36 | 🌐 Lua | 📅 2026-08-06 - A Lua implementation of `nvim-hlchunk`, contains more features, such as highlight `{}` chunk, indent line, space blank etc.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,854 | 🐛 16 | 🌐 Lua | 📅 2026-08-15 - A small automated session manager.
* [folke/persistence.nvim](https://github.com/folke/persistence.nvim) ⭐ 1,008 | 🐛 9 | 🌐 Lua | 📅 2025-10-28 - Simple automated session management.
...
* [azratul/live-share.nvim](https://github.com/azratul/live-share.nvim) ⭐ 278 | 🐛 0 | 🌐 Lua | 📅 2026-07-31 - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 422 | 🐛 27 | 🌐 Lua | 📅 2026-08-25 - Live preview HTML, Markdown and Asciidoc in the browser.
* [SUSTech-data/neopyter](https://github.com/SUSTech-data/neopyter) ⭐ 172 | 🐛 4 | 🌐 Lua | 📅 2026-05-20 - Edit and preview/run in Jupyter Lab.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,713 | 🐛 22 | 🌐 Lua | 📅 2026-08-22 - Smart, seamless, directional navigation and resizing of splits.
...
* [Eandrju/cellular-automaton.nvim](https://github.com/Eandrju/cellular-automaton.nvim) ⭐ 2,097 | 🐛 13 | 🌐 Lua | 📅 2025-01-31 - It lets you execute aesthetically pleasing, cellular automaton animations based on the content of the current buffer.
...
* [m4xshen/hardtime.nvim](https://github.com/m4xshen/hardtime.nvim) ⭐ 3,836 | 🐛 15 | 🌐 Lua | 📅 2026-07-20 - Helping you establish good command workflow and habit.
...
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 225 | 🐛 8 | 🌐 Lua | 📅 2026-08-25 - A single workflow for GitHub, GitLab, Bitbucket, and Jira.
...
* [gisketch/triforce.nvim](https://github.com/gisketch/triforce.nvim) ⭐ 308 | 🐛 0 | 🌐 Lua | 📅 2026-08-17 - Gamified stat tracker with XP, levels, achievements, and activity heatmaps for your coding sessions with lualine integration.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 102 | 🐛 29 | 🌐 Go | 📅 2026-08-25 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [yal212/pomodoro.nvim](https://github.com/yal212/pomodoro.nvim) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-07-11 - Focus-first Pomodoro timer with automatic work, break cycles, session statistics, and a distraction-free focus mode.
...
* [kndndrj/nvim-dbee](https://github.com/kndndrj/nvim-dbee) ⭐ 1,304 | 🐛 77 | 🌐 Go | 📅 2025-07-25 - Interactive database client.
...
* [clang-engineer/dadbod-vertica.nvim](https://github.com/clang-engineer/dadbod-vertica.nvim) ⭐ 2 | 🐛 0 | 🌐 Vim Script | 📅 2026-07-06 - Vertica adapter for [vim-dadbod](https://github.com/tpope/vim-dadbod) ⭐ 4,434 | 🐛 58 | 🌐 Vim Script | 📅 2026-01-07 via the official `vsql` client, with schema-tree integration for `vim-dadbod-ui`.
...
* [SpaceVim/SpaceVim](https://spacevim.org) - A community-driven modular distribution, inspired by [spacemacs](https://github.com/syl20bnr/spacemacs) ⭐ 24,560 | 🐛 60 | 🌐 Emacs Lisp | 📅 2026-08-23.

<!--lint enable double-link -->

* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 31,319 | 🐛 22 | 🌐 Lua | 📅 2026-08-07 - A launch point for your personal configuration.
...
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 27,270 | 🐛 78 | 🌐 Lua | 📅 2026-06-02 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,425 | 🐛 0 | 🌐 Lua | 📅 2026-08-13 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,420 | 🐛 3 | 🌐 Lua | 📅 2026-08-15 - A well-configured and structured configuration with NixOS support.
* [shaunsingh/nyoom.nvim](https://github.com/shaunsingh/nyoom.nvim) ⭐ 1,627 | 🐛 30 | 🌐 Fennel | 📅 2023-11-05 - Blazing fast, configurable, minimal and "lispy" config written in Fennel.
* [CosmicNvim/CosmicNvim](https://github.com/CosmicNvim/CosmicNvim) ⭐ 1,164 | 🐛 0 | 🌐 Lua | 📅 2026-08-19 - CosmicNvim is a lightweight and opinionated config for web development, specifically designed to provide a COSMIC programming experience.
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 1,013 | 🐛 3 | 🌐 Lua | 📅 2026-07-25 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [crivotz/nv-ide](https://github.com/crivotz/nv-ide) ⭐ 650 | 🐛 1 | 🌐 Lua | 📅 2026-07-15 - Custom configuration oriented for Full-Stack developers (Rails, Ruby, PHP, HTML, CSS, SCSS, JavaScript).
...
* [shaeinst/roshnivim](https://github.com/shaeinst/roshnivim) ⭐ 213 | 🐛 2 | 🌐 Lua | 📅 2026-08-19 - A predefined config to save you thousands of hours to setup your editor as an IDE.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,140 | 🐛 18 | 🌐 Rust | 📅 2026-08-25 - A cross-platform, easy to use version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 38 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - Another version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-08-24 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [nvim-mini/mini.nvim#mini.input](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-input.md) ⭐ 9,458 | 🐛 35 | 🌐 Lua | 📅 2026-08-25 - Module of `mini.nvim` for getting user input with fully customizable key and view handling. Can show as floating window, statusline/tabline/winbar, virtual line/text. Provides `vim.ui.input()` implementation.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,810 | 🐛 33 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
* [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) ⭐ 3,567 | 🐛 80 | 🌐 Lua | 📅 2025-09-06 - A fancy, configurable, notification manager.
...
* [akrawchyk/awesome-vim#tools](https://github.com/akrawchyk/awesome-vim#tools) ⭐ 2,127 | 🐛 11 | 📅 2025-06-06 - A short list of Vim plugins and helpful guides.
