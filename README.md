...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 21,545 | 🐛 66 | 🌐 Lua | 📅 2026-06-29 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,939 | 🐛 34 | 🌐 Lua | 📅 2026-09-10 - Quickstart configurations for the LSP client.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 1,024 | 🐛 11 | 🌐 Lua | 📅 2026-09-10 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,840 | 🐛 86 | 🌐 JavaScript | 📅 2026-09-11 catalog.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,475 | 🐛 277 | 🌐 Lua | 📅 2026-06-19 - Easily install and manage LSP servers, DAP servers, linters, and formatters.
...
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 3,112 | 🐛 20 | 🌐 Lua | 📅 2026-09-11 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 610 | 🐛 21 | 🌐 Lua | 📅 2026-09-11 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,890 | 🐛 19 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
...
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,569 | 🐛 98 | 🌐 Lua | 📅 2026-09-10 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-07-16 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 49,188 | 🐛 29 | 🌐 C | 📅 2026-09-11.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,099 | 🐛 18 | 🌐 Lua | 📅 2026-09-10 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,686 | 🐛 66 | 🌐 Vim Script | 📅 2026-08-11.
...
* [coder/claudecode.nvim](https://github.com/coder/claudecode.nvim) ⭐ 3,057 | 🐛 94 | 🌐 Lua | 📅 2026-09-03 - Claude Code integration using the WebSocket-based MCP protocol, with selection and diagnostics context sharing plus inline diffs.
  * [hebercosfer/floating-claude.nvim](https://github.com/hebercosfer/floating-claude.nvim) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-09-03 - Floating terminal provider for [claudecode.nvim](https://github.com/coder/claudecode.nvim) ⭐ 3,057 | 🐛 94 | 🌐 Lua | 📅 2026-09-03 that collapses into a corner notification while Claude edits and returns once idle.

<!--lint enable double-link-->

* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,157 | 🐛 43 | 🌐 Lua | 📅 2026-09-09 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,852 | 🐛 11 | 🌐 Lua | 📅 2026-09-11 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,821 | 🐛 6 | 🌐 Lua | 📅 2026-09-11 - OpenCode AI assistant integration.
...
* [zgs225/pi2.nvim](https://github.com/zgs225/pi2.nvim) ⭐ 20 | 🐛 1 | 🌐 Lua | 📅 2026-09-11 - Frontend for the [pi](https://pi.dev) coding agent with in-editor chat, reviewed diffs, session-tree navigation, and extension prompts.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 9 | 🐛 4 | 🌐 Lua | 📅 2026-09-11 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 12,489 | 🐛 689 | 🌐 Python | 📅 2026-09-08 tool.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 8 | 🐛 2 | 🌐 Lua | 📅 2026-09-11 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
...
* [nvim-flutter/flutter-tools.nvim](https://github.com/nvim-flutter/flutter-tools.nvim) ⭐ 1,410 | 🐛 31 | 🌐 Lua | 📅 2026-09-08 - Build Flutter and Dart applications using the native LSP.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 579 | 🐛 36 | 🌐 Lua | 📅 2026-09-07 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [ray-x/go.nvim](https://github.com/ray-x/go.nvim) ⭐ 2,658 | 🐛 96 | 🌐 Lua | 📅 2026-09-11 - Golang plugin based on LSP and Tree-sitter.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,990 | 🐛 265 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 5,014 | 🐛 13 | 🌐 Lua | 📅 2026-08-11 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,633 | 🐛 4 | 🌐 Lua | 📅 2026-08-14 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [rogue-87/inlyne.nvim](https://github.com/rogue-87/inlyne.nvim) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2026-09-07 - Wrapper for [inlyne](https://github.com/Inlyne-Project/inlyne) ⭐ 1,344 | 🐛 65 | 🌐 Rust | 📅 2026-08-06 Markdown viewer.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 14,385 | 🐛 270 | 🌐 Tree-sitter Query | 📅 2026-09-11 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
...
* [romus204/tree-sitter-manager.nvim](https://github.com/romus204/tree-sitter-manager.nvim) ⭐ 875 | 🐛 14 | 🌐 Tree-sitter Query | 📅 2026-09-05 - A lightweight Tree-sitter parser manager for Neovim 0.12+.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
...
* [dcampos/nvim-snippy](https://github.com/dcampos/nvim-snippy) ⭐ 341 | 🐛 8 | 🌐 Lua | 📅 2026-06-26 - Snippet plugin written in Lua with support for [vim-snippets](https://github.com/honza/vim-snippets) ⭐ 4,880 | 🐛 83 | 🌐 Vim Snippet | 📅 2025-10-28.
...
* [wurli/visimatch.nvim](https://github.com/wurli/visimatch.nvim) ⭐ 82 | 🐛 7 | 🌐 Lua | 📅 2026-09-11 - Adds highlights to any text matching the current selection in visual mode.
...
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 10,695 | 🐛 85 | 🌐 Rust | 📅 2026-09-11 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
...
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,437 | 🐛 12 | 🌐 Lua | 📅 2026-09-01 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,948 | 🐛 5 | 🌐 Rust | 📅 2026-09-08 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 371 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,395 | 🐛 145 | 🌐 Rust | 📅 2026-09-08, a smart directory picker that tracks your usage.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,640 | 🐛 101 | 🌐 Lua | 📅 2026-09-11 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,887 | 🐛 154 | 🌐 Lua | 📅 2026-06-02 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,589 | 🐛 174 | 🌐 Lua | 📅 2026-09-07 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,863 | 🐛 9 | 🌐 Lua | 📅 2026-09-11 - Integration with the Yazi terminal file manager.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,689 | 🐛 93 | 🌐 Python | 📅 2026-09-11 - File manager. Better than NERDTree.
* [kevinhwang91/rnvimr](https://github.com/kevinhwang91/rnvimr) ⭐ 847 | 🐛 10 | 🌐 Python | 📅 2026-01-11 - A simple yet amazing file explorer.
* [A7Lavinraj/fyler.nvim](https://github.com/A7Lavinraj/fyler.nvim) ⭐ 766 | 🐛 25 | 🌐 Lua | 📅 2026-08-18 - File manager which can edit file system like a buffer with tree view.
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 462 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,878 | 🐛 4 | 🌐 C | 📅 2026-09-09 and Lua.
...
* [SidOfc/carbon.nvim](https://github.com/SidOfc/carbon.nvim) ⭐ 187 | 🐛 1 | 🌐 Lua | 📅 2026-09-11 - The simple directory tree viewer written in Lua.
...
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 101 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 42,121 | 🐛 67 | 🌐 Rust | 📅 2026-09-10).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 199 | 🐛 2 | 🌐 Lua | 📅 2026-09-11 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 87 | 🐛 5 | 🌐 Lua | 📅 2026-09-11 - Easily load project-local settings (like `.vscode/settings.json`) into native LSP settings.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [uga-rosa/ccc.nvim](https://github.com/uga-rosa/ccc.nvim) ⭐ 986 | 🐛 14 | 🌐 Lua | 📅 2025-05-06 - Super powerful color picker / colorizer plugin.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 8,181 | 🐛 21 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 4,207 | 🐛 6 | 🌐 Vim Script | 📅 2026-06-08 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [projekt0n/github-nvim-theme](https://github.com/projekt0n/github-nvim-theme) ⭐ 2,477 | 🐛 28 | 🌐 Lua | 📅 2024-12-31 - ***`[TS][LSP][L/D][Lua]`*** A GitHub theme, kitty, alacritty written in Lua. Support built-in LSP and Tree-sitter.
...
* [savq/melange-nvim](https://github.com/savq/melange-nvim) ⭐ 977 | 🐛 12 | 🌐 Lua | 📅 2025-12-10 - ***`[TS][LSP][L/D][Lua]`*** Warm colorscheme written in Lua with support for various terminal emulators.
...
* [ThorstenRhau/token](https://github.com/ThorstenRhau/token) ⭐ 307 | 🐛 0 | 🌐 Emacs Lisp | 📅 2026-09-09 - ***`[TS][LSP][L/D][Lua]`*** Token has warm tones and careful contrast, with full Tree-sitter and LSP integration.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 3,090 | 🐛 5 | 🌐 Lua | 📅 2026-05-15 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,618 | 🐛 11 | 🌐 Lua | 📅 2026-08-09 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,386 | 🐛 91 | 🌐 Lua | 📅 2026-05-10 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,602 | 🐛 28 | 🌐 Lua | 📅 2026-04-15 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [zaldih/themery.nvim](https://github.com/zaldih/themery.nvim) ⭐ 379 | 🐛 19 | 🌐 Lua | 📅 2025-01-01 - A new way to change the colorscheme on the fly like in VSCode.
...
* [nvim-mini/mini.nvim#mini.statuscolumn](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statuscolumn.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for statuscolumn. Fast and improved defaults, fully customizable content, automatic dimming inside inactive windows.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 8,122 | 🐛 271 | 🌐 Lua | 📅 2026-05-31 - Easily configurable, blazingly fast statusline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,874 | 🐛 151 | 🌐 Lua | 📅 2026-08-20 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 2,153 | 🐛 51 | 🌐 Lua | 📅 2026-09-11 - Plugin for Obsidian, written in Lua.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 40 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,961 | 🐛 59 | 🌐 Rust | 📅 2026-07-04, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,252 | 🐛 32 | 🌐 Lua | 📅 2026-09-11 - Debug Adapter Protocol client implementation.
...
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,218 | 🐛 41 | 🌐 Python | 📅 2026-07-03 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` with framework for writing extensive plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,494 | 🐛 158 | 🌐 Lua | 📅 2026-04-10 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-05-26 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 23,544 | 🐛 18 | 🌐 Go | 📅 2026-08-29 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,141 | 🐛 90 | 🌐 Fennel | 📅 2026-09-11 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for enhanced Git integration with current editor process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 7,090 | 🐛 41 | 🌐 Lua | 📅 2026-09-11 - Git integration: signs, hunk actions, blame, etc.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,617 | 🐛 201 | 🌐 Lua | 📅 2026-08-22 - A Magit clone that may change some things to fit the Vim philosophy.
...
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 323 | 🐛 6 | 🌐 Lua | 📅 2026-09-08 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 295 | 🐛 1 | 🌐 Go | 📅 2026-09-11 - A TUI native Git mergetool with 3 panes.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 127 | 🐛 7 | 🌐 Lua | 📅 2026-08-12 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 32,151 | 🐛 438 | 🌐 Rust | 📅 2026-09-11, with enhanced navigational features.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,379 | 🐛 245 | 🌐 Lua | 📅 2026-08-28 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 4,233 | 🐛 28 | 🌐 Lua | 📅 2026-08-22 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [kkew3/jieba.vim](https://github.com/kkew3/jieba.vim) ⭐ 62 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - Word motions and word text objects for Chinese.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,286 | 🐛 40 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
* [petertriho/nvim-scrollbar](https://github.com/petertriho/nvim-scrollbar) ⭐ 1,072 | 🐛 30 | 🌐 Lua | 📅 2026-08-16 - Extensible scrollbar that shows diagnostics and search results.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
* [windwp/nvim-autopairs](https://github.com/windwp/nvim-autopairs) ⭐ 4,092 | 🐛 15 | 🌐 Lua | 📅 2026-08-23 - A minimalist autopairs written by Lua.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for session management (read, write, delete).
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 426 | 🐛 28 | 🌐 Lua | 📅 2026-09-06 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,719 | 🐛 4 | 🌐 Lua | 📅 2026-09-11 - Smart, seamless, directional navigation and resizing of splits.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,183 | 🐛 65 | 🌐 Lua | 📅 2026-04-28 - Solve Leetcode problems.
...
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 252 | 🐛 13 | 🌐 Lua | 📅 2026-09-08 - A single workflow for GitHub, GitLab, Bitbucket, and Jira.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 103 | 🐛 29 | 🌐 Go | 📅 2026-09-11 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [joryeugene/dadbod-grip.nvim](https://github.com/joryeugene/dadbod-grip.nvim) ⭐ 169 | 🐛 1 | 🌐 Lua | 📅 2026-09-02 - Database editor with inline cell editing, staged mutations with live SQL preview, schema browser, DDL, AI SQL generation, FK navigation, and DuckDB/Parquet support.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 31,442 | 🐛 17 | 🌐 Lua | 📅 2026-09-09 - A launch point for your personal configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,478 | 🐛 3 | 🌐 Lua | 📅 2026-07-03 - An attempt to make the built-in CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 27,443 | 🐛 75 | 🌐 Lua | 📅 2026-09-08 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [nvim-mini/mini.nvim#mini.input](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-input.md) ⭐ 9,507 | 🐛 37 | 🌐 Lua | 📅 2026-09-10 - Module of `mini.nvim` for getting user input with fully customizable key and view handling. Can show as floating window, statusline/tabline/winbar, virtual line/text. Provides `vim.ui.input()` implementation.
...
* [wsdjeg/calendar.nvim](https://github.com/wsdjeg/calendar.nvim) ⭐ 52 | 🐛 1 | 🌐 Lua | 📅 2026-09-11 - A simple floating calendar with extensions support.
